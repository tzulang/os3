...
8010003a:	c7 44 24 04 50 84 10 	movl   $0x80108450,0x4(%esp)
80100041:	80 
...
80100198:	c7 04 24 57 84 10 80 	movl   $0x80108457,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 68 84 10 80 	movl   $0x80108468,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 6f 84 10 80 	movl   $0x8010846f,(%esp)
...
801003c5:	75 0c                	jne    801003d3 <cprintf+0x33>
    panic("null fmt");
801003c7:	c7 04 24 76 84 10 80 	movl   $0x80108476,(%esp)
...
801004ae:	75 09                	jne    801004b9 <cprintf+0x119>
        s = "(null)";
801004b0:	c7 45 ec 7f 84 10 80 	movl   $0x8010847f,-0x14(%ebp)
      for(; *s; s++)
...
8010055f:	c7 04 24 86 84 10 80 	movl   $0x80108486,(%esp)
...
80100571:	e8 2a fe ff ff       	call   801003a0 <cprintf>
  cprintf("\n");
80100576:	c7 04 24 95 84 10 80 	movl   $0x80108495,(%esp)
...
801005a8:	c7 04 24 97 84 10 80 	movl   $0x80108497,(%esp)
...
80100776:	e8 cc 62 00 00       	call   80106a47 <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 c0 62 00 00       	call   80106a47 <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 b4 62 00 00       	call   80106a47 <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 a7 62 00 00       	call   80106a47 <uartputc>
  cgaputc(c);
...
80100a87:	c7 44 24 04 9b 84 10 	movl   $0x8010849b,0x4(%esp)
80100a8e:	80 
80100a8f:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
80100a96:	e8 67 43 00 00       	call   80104e02 <initlock>
  initlock(&input.lock, "input");
80100a9b:	c7 44 24 04 a3 84 10 	movl   $0x801084a3,0x4(%esp)
80100aa2:	80 
...
80100b6e:	e9 69 03 00 00       	jmp    80100edc <exec+0x3ed>
  ...
  if((pgdir = setupkvm()) == 0)
80100b73:	e8 61 70 00 00       	call   80107bd9 <setupkvm>
...
80100c14:	e8 96 73 00 00       	call   80107faf <allocuvm>
...
80100c52:	e8 6d 72 00 00       	call   80107ec4 <loaduvm>
...
80100cc0:	e8 ea 72 00 00       	call   80107faf <allocuvm>
...
80100ce5:	e8 f5 74 00 00       	call   801081df <clearpteu>
  sp = sz;
...
80100d74:	e8 2b 76 00 00       	call   801083a4 <copyout>
...
80100e1b:	e8 84 75 00 00       	call   801083a4 <copyout>
...
80100ec5:	e8 08 6e 00 00       	call   80107cd2 <switchuvm>
  freevm(oldpgdir);
80100eca:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100ecd:	89 04 24             	mov    %eax,(%esp)
80100ed0:	e8 70 72 00 00       	call   80108145 <freevm>
  return 0;
...
80100ee8:	e8 58 72 00 00       	call   80108145 <freevm>
  if(ip){
...
80100f10:	c7 44 24 04 a9 84 10 	movl   $0x801084a9,0x4(%esp)
80100f17:	80 
...
80100fa0:	7f 0c                	jg     80100fae <filedup+0x28>
    panic("filedup");
80100fa2:	c7 04 24 b0 84 10 80 	movl   $0x801084b0,(%esp)
...
80100fe8:	7f 0c                	jg     80100ff6 <fileclose+0x28>
    panic("fileclose");
80100fea:	c7 04 24 b8 84 10 80 	movl   $0x801084b8,(%esp)
...
8010119f:	eb 0c                	jmp    801011ad <fileread+0xba>
  ...
  panic("fileread");
801011a1:	c7 04 24 c2 84 10 80 	movl   $0x801084c2,(%esp)
...
801012ad:	c7 04 24 cb 84 10 80 	movl   $0x801084cb,(%esp)
...
801012dd:	eb 0c                	jmp    801012eb <filewrite+0x13c>
  ...
  panic("filewrite");
801012df:	c7 04 24 db 84 10 80 	movl   $0x801084db,(%esp)
...
801014c8:	c7 04 24 e5 84 10 80 	movl   $0x801084e5,(%esp)
...
8010155a:	c7 04 24 fb 84 10 80 	movl   $0x801084fb,(%esp)
...
801015aa:	c7 44 24 04 0e 85 10 	movl   $0x8010850e,0x4(%esp)
801015b1:	80 
...
80101691:	c7 04 24 15 85 10 80 	movl   $0x80108515,(%esp)
...
801017e1:	c7 04 24 27 85 10 80 	movl   $0x80108527,(%esp)
...
8010186f:	7f 0c                	jg     8010187d <ilock+0x22>
    panic("ilock");
80101871:	c7 04 24 37 85 10 80 	movl   $0x80108537,(%esp)
...
80101999:	75 0c                	jne    801019a7 <ilock+0x14c>
      panic("ilock: no type");
8010199b:	c7 04 24 3d 85 10 80 	movl   $0x8010853d,(%esp)
...
801019ca:	7f 0c                	jg     801019d8 <iunlock+0x2f>
    panic("iunlock");
801019cc:	c7 04 24 4c 85 10 80 	movl   $0x8010854c,(%esp)
...
80101a57:	74 0c                	je     80101a65 <iput+0x57>
      panic("iput busy");
80101a59:	c7 04 24 54 85 10 80 	movl   $0x80108554,(%esp)
...
80101bf8:	c7 04 24 5e 85 10 80 	movl   $0x8010855e,(%esp)
...
80102090:	c7 04 24 71 85 10 80 	movl   $0x80108571,(%esp)
...
801020cc:	74 0c                	je     801020da <dirlookup+0x5d>
      panic("dirlink read");
801020ce:	c7 04 24 83 85 10 80 	movl   $0x80108583,(%esp)
...
801021b1:	74 0c                	je     801021bf <dirlink+0x79>
      panic("dirlink read");
801021b3:	c7 04 24 83 85 10 80 	movl   $0x80108583,(%esp)
...
80102228:	74 0c                	je     80102236 <dirlink+0xf0>
    panic("dirlink");
8010222a:	c7 04 24 90 85 10 80 	movl   $0x80108590,(%esp)
...
80102519:	c7 44 24 04 98 85 10 	movl   $0x80108598,0x4(%esp)
80102520:	80 
...
801025c3:	75 0c                	jne    801025d1 <idestart+0x18>
    panic("idestart");
801025c5:	c7 04 24 9c 85 10 80 	movl   $0x8010859c,(%esp)
...
801027b3:	c7 04 24 a5 85 10 80 	movl   $0x801085a5,(%esp)
...
801027cc:	c7 04 24 b9 85 10 80 	movl   $0x801085b9,(%esp)
...
801027eb:	c7 04 24 ce 85 10 80 	movl   $0x801085ce,(%esp)
...
80102900:	c7 04 24 ec 85 10 80 	movl   $0x801085ec,(%esp)
...
801029ba:	c7 44 24 04 1e 86 10 	movl   $0x8010861e,0x4(%esp)
801029c1:	80 
...
80102a74:	76 0c                	jbe    80102a82 <kfree+0x39>
    panic("kfree");
80102a76:	c7 04 24 23 86 10 80 	movl   $0x80108623,(%esp)
...
80102ea5:	c7 04 24 2c 86 10 80 	movl   $0x8010862c,(%esp)
...
80103208:	c7 44 24 04 58 86 10 	movl   $0x80108658,0x4(%esp)
8010320f:	80 
...
801034c3:	c7 04 24 5c 86 10 80 	movl   $0x8010865c,(%esp)
...
8010363d:	c7 04 24 6b 86 10 80 	movl   $0x8010866b,(%esp)
...
80103652:	c7 04 24 81 86 10 80 	movl   $0x80108681,(%esp)
...
80103761:	c7 04 24 9c 86 10 80 	movl   $0x8010869c,(%esp)
...
8010377c:	e8 b6 31 00 00       	call   80106937 <uartinit>
  pinit();         // process table
80103781:	e8 96 0b 00 00       	call   8010431c <pinit>
  tvinit();        // trap vectors
80103786:	e8 5b 2d 00 00       	call   801064e6 <tvinit>
  binit();         // buffer cache
...
801037a8:	e8 84 2c 00 00       	call   80106431 <timerinit>
...
801037dd:	e8 d2 44 00 00       	call   80107cb4 <switchkvm>
  seginit();
801037e2:	e8 01 3e 00 00       	call   801075e8 <seginit>
  kvmalloc(cpu);
801037e7:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801037ed:	89 04 24             	mov    %eax,(%esp)
801037f0:	e8 a1 44 00 00       	call   80107c96 <kvmalloc>
  lapicinit();
...
80103815:	c7 04 24 b3 86 10 80 	movl   $0x801086b3,(%esp)
8010381c:	e8 7f cb ff ff       	call   801003a0 <cprintf>
  idtinit();       // load idt register
80103821:	e8 34 2e 00 00       	call   8010665a <idtinit>
...
801039fe:	00 
801039ff:	c7 44 24 04 c4 86 10 	movl   $0x801086c4,0x4(%esp)
80103a06:	80 
...
80103b3f:	00 
80103b40:	c7 44 24 04 c9 86 10 	movl   $0x801086c9,0x4(%esp)
80103b47:	80 
...
80103c1c:	8b 04 85 0c 87 10 80 	mov    -0x7fef78f4(,%eax,4),%eax
...
80103c55:	c7 04 24 ce 86 10 80 	movl   $0x801086ce,(%esp)
...
80103cf0:	c7 04 24 ec 86 10 80 	movl   $0x801086ec,(%esp)
...
80103fe9:	c7 44 24 04 20 87 10 	movl   $0x80108720,0x4(%esp)
80103ff0:	80 
...
80104322:	c7 44 24 04 25 87 10 	movl   $0x80108725,0x4(%esp)
80104329:	80 
...
801043ef:	ba a1 64 10 80       	mov    $0x801064a1,%edx
...
8010444d:	e8 87 37 00 00       	call   80107bd9 <setupkvm>
...
80104462:	c7 04 24 2c 87 10 80 	movl   $0x8010872c,(%esp)
...
80104488:	e8 ac 39 00 00       	call   80107e39 <inituvm>
  p->sz = PGSIZE;
...
80104528:	00 
80104529:	c7 44 24 04 45 87 10 	movl   $0x80108745,0x4(%esp)
80104530:	80 
80104531:	89 04 24             	mov    %eax,(%esp)
80104534:	e8 5e 0d 00 00       	call   80105297 <safestrcpy>
  p->cwd = namei("/");
80104539:	c7 04 24 4e 87 10 80 	movl   $0x8010874e,(%esp)
...
8010458d:	e8 1d 3a 00 00       	call   80107faf <allocuvm>
...
801045c7:	e8 bd 3a 00 00       	call   80108089 <deallocuvm>
...
801045f0:	e8 dd 36 00 00       	call   80107cd2 <switchuvm>
  return 0;
...
80104635:	e8 eb 3b 00 00       	call   80108225 <copyuvm>
...
8010478b:	75 0c                	jne    80104799 <exit+0x22>
    panic("init exiting");
8010478d:	c7 04 24 50 87 10 80 	movl   $0x80108750,(%esp)
...
80104888:	e8 bc 01 00 00       	call   80104a49 <sched>
  panic("zombie exit");
8010488d:	c7 04 24 5d 87 10 80 	movl   $0x8010875d,(%esp)
...
8010490f:	e8 31 38 00 00       	call   80108145 <freevm>
        p->state = UNUSED;
...
801049e4:	e8 e9 32 00 00       	call   80107cd2 <switchuvm>
      p->state = RUNNING;
...
80104a1b:	e8 94 32 00 00       	call   80107cb4 <switchkvm>
...
80104a5f:	c7 04 24 69 87 10 80 	movl   $0x80108769,(%esp)
...
80104a7a:	74 0c                	je     80104a88 <sched+0x3f>
    panic("sched locks");
80104a7c:	c7 04 24 7b 87 10 80 	movl   $0x8010877b,(%esp)
...
80104a94:	75 0c                	jne    80104aa2 <sched+0x59>
    panic("sched running");
80104a96:	c7 04 24 87 87 10 80 	movl   $0x80108787,(%esp)
...
80104ab0:	c7 04 24 95 87 10 80 	movl   $0x80108795,(%esp)
...
80104b67:	75 0c                	jne    80104b75 <sleep+0x1c>
    panic("sleep");
80104b69:	c7 04 24 a9 87 10 80 	movl   $0x801087a9,(%esp)
...
80104b7b:	c7 04 24 af 87 10 80 	movl   $0x801087af,(%esp)
...
80104d22:	eb 07                	jmp    80104d2b <procdump+0x56>
      ...
      state = "???";
80104d24:	c7 45 ec c0 87 10 80 	movl   $0x801087c0,-0x14(%ebp)
...
80104d46:	c7 04 24 c4 87 10 80 	movl   $0x801087c4,(%esp)
...
80104d8c:	c7 04 24 cd 87 10 80 	movl   $0x801087cd,(%esp)
...
80104dab:	75 d4                	jne    80104d81 <procdump+0xac>
    ...
    cprintf("\n");
80104dad:	c7 04 24 d1 87 10 80 	movl   $0x801087d1,(%esp)
...
80104e3b:	74 0c                	je     80104e49 <acquire+0x26>
    panic("acquire");
80104e3d:	c7 04 24 fd 87 10 80 	movl   $0x801087fd,(%esp)
...
80104e98:	75 0c                	jne    80104ea6 <release+0x21>
    panic("release");
80104e9a:	c7 04 24 05 88 10 80 	movl   $0x80108805,(%esp)
...
80104fcf:	c7 04 24 0d 88 10 80 	movl   $0x8010880d,(%esp)
...
80104ff8:	79 0c                	jns    80105006 <popcli+0x4b>
    panic("popcli");
80104ffa:	c7 04 24 24 88 10 80 	movl   $0x80108824,(%esp)
...
801054ed:	c7 04 24 2b 88 10 80 	movl   $0x8010882b,(%esp)
...
80105986:	c7 04 24 47 88 10 80 	movl   $0x80108847,(%esp)
...
80105a20:	c7 44 24 04 59 88 10 	movl   $0x80108859,0x4(%esp)
80105a27:	80 
...
80105a3b:	c7 44 24 04 5b 88 10 	movl   $0x8010885b,0x4(%esp)
80105a42:	80 
...
80105a94:	c7 04 24 5e 88 10 80 	movl   $0x8010885e,(%esp)
...
80105b0b:	74 0c                	je     80105b19 <sys_unlink+0x15a>
    panic("unlink: writei");
80105b0d:	c7 04 24 70 88 10 80 	movl   $0x80108870,(%esp)
...
80105c67:	75 0c                	jne    80105c75 <create+0xde>
    panic("create: ialloc");
80105c69:	c7 04 24 7f 88 10 80 	movl   $0x8010887f,(%esp)
...
80105cd7:	c7 44 24 04 59 88 10 	movl   $0x80108859,0x4(%esp)
80105cde:	80 
...
80105cf8:	c7 44 24 04 5b 88 10 	movl   $0x8010885b,0x4(%esp)
80105cff:	80 
...
80105d0d:	79 0c                	jns    80105d1b <create+0x184>
      panic("create dots");
80105d0f:	c7 04 24 8e 88 10 80 	movl   $0x8010888e,(%esp)
...
80105d3b:	c7 04 24 9a 88 10 80 	movl   $0x8010889a,(%esp)
...
80106318:	eb 3a                	jmp    80106354 <sys_sbrk+0x5e>
  // if(n>=0){
  addr = proc->sz;
...
8010632b:	e8 27 e2 ff ff       	call   80104557 <growproc>
80106330:	85 c0                	test   %eax,%eax
80106332:	79 07                	jns    8010633b <sys_sbrk+0x45>
    return -1;
80106334:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106339:	eb 19                	jmp    80106354 <sys_sbrk+0x5e>
  proc->sz+= n;
8010633b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106341:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80106348:	8b 0a                	mov    (%edx),%ecx
8010634a:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010634d:	01 ca                	add    %ecx,%edx
...
8010636a:	e8 4a f0 ff ff       	call   801053b9 <argint>
8010636f:	85 c0                	test   %eax,%eax
80106371:	79 07                	jns    8010637a <sys_sleep+0x24>
    return -1;
80106373:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106378:	eb 6c                	jmp    801063e6 <sys_sleep+0x90>
  acquire(&tickslock);
8010637a:	c7 04 24 c0 48 11 80 	movl   $0x801148c0,(%esp)
80106381:	e8 9d ea ff ff       	call   80104e23 <acquire>
  ticks0 = ticks;
80106386:	a1 00 51 11 80       	mov    0x80115100,%eax
8010638b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
8010638e:	eb 34                	jmp    801063c4 <sys_sleep+0x6e>
    if(proc->killed){
80106390:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106396:	8b 40 24             	mov    0x24(%eax),%eax
80106399:	85 c0                	test   %eax,%eax
8010639b:	74 13                	je     801063b0 <sys_sleep+0x5a>
      release(&tickslock);
8010639d:	c7 04 24 c0 48 11 80 	movl   $0x801148c0,(%esp)
801063a4:	e8 dc ea ff ff       	call   80104e85 <release>
      return -1;
801063a9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063ae:	eb 36                	jmp    801063e6 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
801063b0:	c7 44 24 04 c0 48 11 	movl   $0x801148c0,0x4(%esp)
801063b7:	80 
801063b8:	c7 04 24 00 51 11 80 	movl   $0x80115100,(%esp)
801063bf:	e8 95 e7 ff ff       	call   80104b59 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801063c4:	a1 00 51 11 80       	mov    0x80115100,%eax
801063c9:	2b 45 f4             	sub    -0xc(%ebp),%eax
801063cc:	89 c2                	mov    %eax,%edx
801063ce:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063d1:	39 c2                	cmp    %eax,%edx
801063d3:	72 bb                	jb     80106390 <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
801063d5:	c7 04 24 c0 48 11 80 	movl   $0x801148c0,(%esp)
801063dc:	e8 a4 ea ff ff       	call   80104e85 <release>
  return 0;
...
801063eb:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
801063ee:	c7 04 24 c0 48 11 80 	movl   $0x801148c0,(%esp)
801063f5:	e8 29 ea ff ff       	call   80104e23 <acquire>
  xticks = ticks;
801063fa:	a1 00 51 11 80       	mov    0x80115100,%eax
801063ff:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106402:	c7 04 24 c0 48 11 80 	movl   $0x801148c0,(%esp)
80106409:	e8 77 ea ff ff       	call   80104e85 <release>
  return xticks;
...
8010641c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010641f:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106423:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106426:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
8010642a:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
80106437:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
8010643e:	00 
8010643f:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
80106446:	e8 c8 ff ff ff       	call   80106413 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
8010644b:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
80106452:	00 
80106453:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
8010645a:	e8 b4 ff ff ff       	call   80106413 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
8010645f:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
80106466:	00 
80106467:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
8010646e:	e8 a0 ff ff ff       	call   80106413 <outb>
  picenable(IRQ_TIMER);
80106473:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010647a:	e8 65 d9 ff ff       	call   80103de4 <picenable>
}
8010647f:	c9                   	leave  
80106480:	c3                   	ret    
...
80106482:	06                   	push   %es
  pushl %fs
80106483:	0f a0                	push   %fs
  pushl %gs
80106485:	0f a8                	push   %gs
  pushal
80106487:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
80106488:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
8010648c:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010648e:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
80106490:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
80106494:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80106496:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
80106498:	54                   	push   %esp
  call trap
80106499:	e8 d8 01 00 00       	call   80106676 <trap>
  addl $4, %esp
8010649e:	83 c4 04             	add    $0x4,%esp
...
801064a1:	61                   	popa   
  popl %gs
801064a2:	0f a9                	pop    %gs
  popl %fs
801064a4:	0f a1                	pop    %fs
  popl %es
801064a6:	07                   	pop    %es
  popl %ds
801064a7:	1f                   	pop    %ds
...
801064fb:	8b 04 85 98 b0 10 80 	mov    -0x7fef4f68(,%eax,4),%eax
80106502:	89 c2                	mov    %eax,%edx
80106504:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106507:	66 89 14 c5 00 49 11 	mov    %dx,-0x7feeb700(,%eax,8)
8010650e:	80 
8010650f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106512:	66 c7 04 c5 02 49 11 	movw   $0x8,-0x7feeb6fe(,%eax,8)
80106519:	80 08 00 
8010651c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010651f:	0f b6 14 c5 04 49 11 	movzbl -0x7feeb6fc(,%eax,8),%edx
80106526:	80 
80106527:	83 e2 e0             	and    $0xffffffe0,%edx
8010652a:	88 14 c5 04 49 11 80 	mov    %dl,-0x7feeb6fc(,%eax,8)
80106531:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106534:	0f b6 14 c5 04 49 11 	movzbl -0x7feeb6fc(,%eax,8),%edx
8010653b:	80 
8010653c:	83 e2 1f             	and    $0x1f,%edx
8010653f:	88 14 c5 04 49 11 80 	mov    %dl,-0x7feeb6fc(,%eax,8)
80106546:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106549:	0f b6 14 c5 05 49 11 	movzbl -0x7feeb6fb(,%eax,8),%edx
80106550:	80 
80106551:	83 e2 f0             	and    $0xfffffff0,%edx
80106554:	83 ca 0e             	or     $0xe,%edx
80106557:	88 14 c5 05 49 11 80 	mov    %dl,-0x7feeb6fb(,%eax,8)
8010655e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106561:	0f b6 14 c5 05 49 11 	movzbl -0x7feeb6fb(,%eax,8),%edx
80106568:	80 
80106569:	83 e2 ef             	and    $0xffffffef,%edx
8010656c:	88 14 c5 05 49 11 80 	mov    %dl,-0x7feeb6fb(,%eax,8)
80106573:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106576:	0f b6 14 c5 05 49 11 	movzbl -0x7feeb6fb(,%eax,8),%edx
8010657d:	80 
8010657e:	83 e2 9f             	and    $0xffffff9f,%edx
80106581:	88 14 c5 05 49 11 80 	mov    %dl,-0x7feeb6fb(,%eax,8)
80106588:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010658b:	0f b6 14 c5 05 49 11 	movzbl -0x7feeb6fb(,%eax,8),%edx
80106592:	80 
80106593:	83 ca 80             	or     $0xffffff80,%edx
80106596:	88 14 c5 05 49 11 80 	mov    %dl,-0x7feeb6fb(,%eax,8)
8010659d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065a0:	8b 04 85 98 b0 10 80 	mov    -0x7fef4f68(,%eax,4),%eax
801065a7:	c1 e8 10             	shr    $0x10,%eax
801065aa:	89 c2                	mov    %eax,%edx
801065ac:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065af:	66 89 14 c5 06 49 11 	mov    %dx,-0x7feeb6fa(,%eax,8)
801065b6:	80 
void
tvinit(void)
{
...
801065c8:	a1 98 b1 10 80       	mov    0x8010b198,%eax
801065cd:	66 a3 00 4b 11 80    	mov    %ax,0x80114b00
801065d3:	66 c7 05 02 4b 11 80 	movw   $0x8,0x80114b02
801065da:	08 00 
801065dc:	0f b6 05 04 4b 11 80 	movzbl 0x80114b04,%eax
801065e3:	83 e0 e0             	and    $0xffffffe0,%eax
801065e6:	a2 04 4b 11 80       	mov    %al,0x80114b04
801065eb:	0f b6 05 04 4b 11 80 	movzbl 0x80114b04,%eax
801065f2:	83 e0 1f             	and    $0x1f,%eax
801065f5:	a2 04 4b 11 80       	mov    %al,0x80114b04
801065fa:	0f b6 05 05 4b 11 80 	movzbl 0x80114b05,%eax
80106601:	83 c8 0f             	or     $0xf,%eax
80106604:	a2 05 4b 11 80       	mov    %al,0x80114b05
80106609:	0f b6 05 05 4b 11 80 	movzbl 0x80114b05,%eax
80106610:	83 e0 ef             	and    $0xffffffef,%eax
80106613:	a2 05 4b 11 80       	mov    %al,0x80114b05
80106618:	0f b6 05 05 4b 11 80 	movzbl 0x80114b05,%eax
8010661f:	83 c8 60             	or     $0x60,%eax
80106622:	a2 05 4b 11 80       	mov    %al,0x80114b05
80106627:	0f b6 05 05 4b 11 80 	movzbl 0x80114b05,%eax
8010662e:	83 c8 80             	or     $0xffffff80,%eax
80106631:	a2 05 4b 11 80       	mov    %al,0x80114b05
80106636:	a1 98 b1 10 80       	mov    0x8010b198,%eax
8010663b:	c1 e8 10             	shr    $0x10,%eax
8010663e:	66 a3 06 4b 11 80    	mov    %ax,0x80114b06
  
  initlock(&tickslock, "time");
80106644:	c7 44 24 04 ac 88 10 	movl   $0x801088ac,0x4(%esp)
8010664b:	80 
8010664c:	c7 04 24 c0 48 11 80 	movl   $0x801148c0,(%esp)
80106653:	e8 aa e7 ff ff       	call   80104e02 <initlock>
}
80106658:	c9                   	leave  
80106659:	c3                   	ret    
...
8010665d:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80106660:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80106667:	00 
80106668:	c7 04 24 00 49 11 80 	movl   $0x80114900,(%esp)
8010666f:	e8 38 fe ff ff       	call   801064ac <lidt>
}
80106674:	c9                   	leave  
80106675:	c3                   	ret    
...
8010667c:	83 ec 3c             	sub    $0x3c,%esp
//	  char *mem;
//	  uint va;
//	  uint newsz;
...
80106682:	8b 40 30             	mov    0x30(%eax),%eax
80106685:	83 f8 40             	cmp    $0x40,%eax
80106688:	75 3f                	jne    801066c9 <trap+0x53>
    if(proc->killed)
8010668a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106690:	8b 40 24             	mov    0x24(%eax),%eax
80106693:	85 c0                	test   %eax,%eax
80106695:	74 05                	je     8010669c <trap+0x26>
      exit();
80106697:	e8 db e0 ff ff       	call   80104777 <exit>
    proc->tf = tf;
8010669c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801066a2:	8b 55 08             	mov    0x8(%ebp),%edx
801066a5:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
801066a8:	e8 d3 ed ff ff       	call   80105480 <syscall>
    if(proc->killed)
801066ad:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801066b3:	8b 40 24             	mov    0x24(%eax),%eax
801066b6:	85 c0                	test   %eax,%eax
801066b8:	74 0a                	je     801066c4 <trap+0x4e>
      exit();
801066ba:	e8 b8 e0 ff ff       	call   80104777 <exit>
    return;
801066bf:	e9 30 02 00 00       	jmp    801068f4 <trap+0x27e>
801066c4:	e9 2b 02 00 00       	jmp    801068f4 <trap+0x27e>
  }

  switch(tf->trapno){
801066c9:	8b 45 08             	mov    0x8(%ebp),%eax
801066cc:	8b 40 30             	mov    0x30(%eax),%eax
801066cf:	83 e8 0e             	sub    $0xe,%eax
801066d2:	83 f8 31             	cmp    $0x31,%eax
801066d5:	0f 87 bc 00 00 00    	ja     80106797 <trap+0x121>
801066db:	8b 04 85 54 89 10 80 	mov    -0x7fef76ac(,%eax,4),%eax
801066e2:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
801066e4:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801066ea:	0f b6 00             	movzbl (%eax),%eax
801066ed:	84 c0                	test   %al,%al
801066ef:	75 31                	jne    80106722 <trap+0xac>
      acquire(&tickslock);
801066f1:	c7 04 24 c0 48 11 80 	movl   $0x801148c0,(%esp)
801066f8:	e8 26 e7 ff ff       	call   80104e23 <acquire>
      ticks++;
801066fd:	a1 00 51 11 80       	mov    0x80115100,%eax
80106702:	83 c0 01             	add    $0x1,%eax
80106705:	a3 00 51 11 80       	mov    %eax,0x80115100
      wakeup(&ticks);
8010670a:	c7 04 24 00 51 11 80 	movl   $0x80115100,(%esp)
80106711:	e8 1c e5 ff ff       	call   80104c32 <wakeup>
      release(&tickslock);
80106716:	c7 04 24 c0 48 11 80 	movl   $0x801148c0,(%esp)
8010671d:	e8 63 e7 ff ff       	call   80104e85 <release>
    }
    lapiceoi();
80106722:	e8 a9 c7 ff ff       	call   80102ed0 <lapiceoi>
    break;
80106727:	e9 41 01 00 00       	jmp    8010686d <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
8010672c:	e8 ad bf ff ff       	call   801026de <ideintr>
    lapiceoi();
80106731:	e8 9a c7 ff ff       	call   80102ed0 <lapiceoi>
    break;
80106736:	e9 32 01 00 00       	jmp    8010686d <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
8010673b:	e8 5f c5 ff ff       	call   80102c9f <kbdintr>
    lapiceoi();
80106740:	e8 8b c7 ff ff       	call   80102ed0 <lapiceoi>
    break;
80106745:	e9 23 01 00 00       	jmp    8010686d <trap+0x1f7>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
8010674a:	e8 9a 03 00 00       	call   80106ae9 <uartintr>
    lapiceoi();
8010674f:	e8 7c c7 ff ff       	call   80102ed0 <lapiceoi>
    break;
80106754:	e9 14 01 00 00       	jmp    8010686d <trap+0x1f7>
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106759:	8b 45 08             	mov    0x8(%ebp),%eax
8010675c:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
8010675f:	8b 45 08             	mov    0x8(%ebp),%eax
80106762:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106766:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
80106769:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010676f:	0f b6 00             	movzbl (%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
...
80106775:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106779:	89 54 24 08          	mov    %edx,0x8(%esp)
8010677d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106781:	c7 04 24 b4 88 10 80 	movl   $0x801088b4,(%esp)
80106788:	e8 13 9c ff ff       	call   801003a0 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
8010678d:	e8 3e c7 ff ff       	call   80102ed0 <lapiceoi>
    break;
80106792:	e9 d6 00 00 00       	jmp    8010686d <trap+0x1f7>
return;
...
8010679f:	74 11                	je     801067b2 <trap+0x13c>
...
801067b0:	75 46                	jne    801067f8 <trap+0x182>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801067b2:	e8 1e fd ff ff       	call   801064d5 <rcr2>
801067b7:	8b 55 08             	mov    0x8(%ebp),%edx
801067ba:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
801067bd:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801067c4:	0f b6 12             	movzbl (%edx),%edx
   break;
  //PAGEBREAK: 13
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801067c7:	0f b6 ca             	movzbl %dl,%ecx
801067ca:	8b 55 08             	mov    0x8(%ebp),%edx
801067cd:	8b 52 30             	mov    0x30(%edx),%edx
801067d0:	89 44 24 10          	mov    %eax,0x10(%esp)
801067d4:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
801067d8:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801067dc:	89 54 24 04          	mov    %edx,0x4(%esp)
801067e0:	c7 04 24 d8 88 10 80 	movl   $0x801088d8,(%esp)
801067e7:	e8 b4 9b ff ff       	call   801003a0 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
801067ec:	c7 04 24 0a 89 10 80 	movl   $0x8010890a,(%esp)
801067f3:	e8 42 9d ff ff       	call   8010053a <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801067f8:	e8 d8 fc ff ff       	call   801064d5 <rcr2>
801067fd:	89 c2                	mov    %eax,%edx
801067ff:	8b 45 08             	mov    0x8(%ebp),%eax
80106802:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106805:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010680b:	0f b6 00             	movzbl (%eax),%eax
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010680e:	0f b6 f0             	movzbl %al,%esi
80106811:	8b 45 08             	mov    0x8(%ebp),%eax
80106814:	8b 58 34             	mov    0x34(%eax),%ebx
80106817:	8b 45 08             	mov    0x8(%ebp),%eax
8010681a:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
8010681d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106823:	83 c0 6c             	add    $0x6c,%eax
80106826:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106829:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010682f:	8b 40 10             	mov    0x10(%eax),%eax
80106832:	89 54 24 1c          	mov    %edx,0x1c(%esp)
80106836:	89 7c 24 18          	mov    %edi,0x18(%esp)
8010683a:	89 74 24 14          	mov    %esi,0x14(%esp)
8010683e:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106842:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106846:	8b 75 e4             	mov    -0x1c(%ebp),%esi
80106849:	89 74 24 08          	mov    %esi,0x8(%esp)
8010684d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106851:	c7 04 24 10 89 10 80 	movl   $0x80108910,(%esp)
80106858:	e8 43 9b ff ff       	call   801003a0 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
8010685d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106863:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
8010686a:	eb 01                	jmp    8010686d <trap+0x1f7>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80106875:	74 24                	je     8010689b <trap+0x225>
80106877:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010687d:	8b 40 24             	mov    0x24(%eax),%eax
80106880:	85 c0                	test   %eax,%eax
80106882:	74 17                	je     8010689b <trap+0x225>
...
80106891:	83 f8 03             	cmp    $0x3,%eax
80106894:	75 05                	jne    8010689b <trap+0x225>
    exit();
80106896:	e8 dc de ff ff       	call   80104777 <exit>
...
801068a3:	74 1e                	je     801068c3 <trap+0x24d>
801068a5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801068ab:	8b 40 0c             	mov    0xc(%eax),%eax
801068ae:	83 f8 04             	cmp    $0x4,%eax
801068b1:	75 10                	jne    801068c3 <trap+0x24d>
801068b3:	8b 45 08             	mov    0x8(%ebp),%eax
801068b6:	8b 40 30             	mov    0x30(%eax),%eax
801068b9:	83 f8 20             	cmp    $0x20,%eax
801068bc:	75 05                	jne    801068c3 <trap+0x24d>
    yield();
801068be:	e8 38 e2 ff ff       	call   80104afb <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
801068c3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801068c9:	85 c0                	test   %eax,%eax
801068cb:	74 27                	je     801068f4 <trap+0x27e>
801068cd:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801068d3:	8b 40 24             	mov    0x24(%eax),%eax
801068d6:	85 c0                	test   %eax,%eax
801068d8:	74 1a                	je     801068f4 <trap+0x27e>
801068da:	8b 45 08             	mov    0x8(%ebp),%eax
801068dd:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
801068e1:	0f b7 c0             	movzwl %ax,%eax
801068e4:	83 e0 03             	and    $0x3,%eax
801068e7:	83 f8 03             	cmp    $0x3,%eax
801068ea:	75 08                	jne    801068f4 <trap+0x27e>
    exit();
801068ec:	e8 86 de ff ff       	call   80104777 <exit>
801068f1:	eb 01                	jmp    801068f4 <trap+0x27e>
...
801068f4:	83 c4 3c             	add    $0x3c,%esp
801068f7:	5b                   	pop    %ebx
801068f8:	5e                   	pop    %esi
801068f9:	5f                   	pop    %edi
801068fa:	5d                   	pop    %ebp
...
801068ff:	83 ec 14             	sub    $0x14,%esp
80106902:	8b 45 08             	mov    0x8(%ebp),%eax
80106905:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106909:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
8010690d:	89 c2                	mov    %eax,%edx
8010690f:	ec                   	in     (%dx),%al
80106910:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
80106913:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
80106917:	c9                   	leave  
80106918:	c3                   	ret    
...
8010691f:	8b 55 08             	mov    0x8(%ebp),%edx
80106922:	8b 45 0c             	mov    0xc(%ebp),%eax
80106925:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106929:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
8010692c:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106930:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
8010693a:	83 ec 28             	sub    $0x28,%esp
  ...
  // Turn off the FIFO
  outb(COM1+2, 0);
8010693d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106944:	00 
80106945:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
8010694c:	e8 c8 ff ff ff       	call   80106919 <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80106951:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80106958:	00 
80106959:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106960:	e8 b4 ff ff ff       	call   80106919 <outb>
  outb(COM1+0, 115200/9600);
80106965:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
8010696c:	00 
8010696d:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106974:	e8 a0 ff ff ff       	call   80106919 <outb>
  outb(COM1+1, 0);
80106979:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106980:	00 
80106981:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106988:	e8 8c ff ff ff       	call   80106919 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
8010698d:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106994:	00 
80106995:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
8010699c:	e8 78 ff ff ff       	call   80106919 <outb>
  outb(COM1+4, 0);
801069a1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801069a8:	00 
801069a9:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
801069b0:	e8 64 ff ff ff       	call   80106919 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
801069b5:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801069bc:	00 
801069bd:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
801069c4:	e8 50 ff ff ff       	call   80106919 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
801069c9:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801069d0:	e8 27 ff ff ff       	call   801068fc <inb>
801069d5:	3c ff                	cmp    $0xff,%al
801069d7:	75 02                	jne    801069db <uartinit+0xa4>
    return;
801069d9:	eb 6a                	jmp    80106a45 <uartinit+0x10e>
  uart = 1;
801069db:	c7 05 4c b6 10 80 01 	movl   $0x1,0x8010b64c
801069e2:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
801069e5:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
801069ec:	e8 0b ff ff ff       	call   801068fc <inb>
  inb(COM1+0);
801069f1:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801069f8:	e8 ff fe ff ff       	call   801068fc <inb>
  picenable(IRQ_COM1);
801069fd:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106a04:	e8 db d3 ff ff       	call   80103de4 <picenable>
  ioapicenable(IRQ_COM1, 0);
80106a09:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106a10:	00 
80106a11:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106a18:	e8 40 bf ff ff       	call   8010295d <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106a1d:	c7 45 f4 1c 8a 10 80 	movl   $0x80108a1c,-0xc(%ebp)
80106a24:	eb 15                	jmp    80106a3b <uartinit+0x104>
    uartputc(*p);
80106a26:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a29:	0f b6 00             	movzbl (%eax),%eax
80106a2c:	0f be c0             	movsbl %al,%eax
80106a2f:	89 04 24             	mov    %eax,(%esp)
80106a32:	e8 10 00 00 00       	call   80106a47 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106a37:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106a3b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a3e:	0f b6 00             	movzbl (%eax),%eax
80106a41:	84 c0                	test   %al,%al
80106a43:	75 e1                	jne    80106a26 <uartinit+0xef>
    uartputc(*p);
}
80106a45:	c9                   	leave  
80106a46:	c3                   	ret    
...
80106a4a:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
80106a4d:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
80106a52:	85 c0                	test   %eax,%eax
80106a54:	75 02                	jne    80106a58 <uartputc+0x11>
    return;
80106a56:	eb 4b                	jmp    80106aa3 <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106a58:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106a5f:	eb 10                	jmp    80106a71 <uartputc+0x2a>
    microdelay(10);
80106a61:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80106a68:	e8 88 c4 ff ff       	call   80102ef5 <microdelay>
{
  int i;
  ...
  if(!uart)
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106a6d:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106a71:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
80106a75:	7f 16                	jg     80106a8d <uartputc+0x46>
80106a77:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106a7e:	e8 79 fe ff ff       	call   801068fc <inb>
80106a83:	0f b6 c0             	movzbl %al,%eax
80106a86:	83 e0 20             	and    $0x20,%eax
80106a89:	85 c0                	test   %eax,%eax
80106a8b:	74 d4                	je     80106a61 <uartputc+0x1a>
    microdelay(10);
  outb(COM1+0, c);
80106a8d:	8b 45 08             	mov    0x8(%ebp),%eax
80106a90:	0f b6 c0             	movzbl %al,%eax
80106a93:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a97:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106a9e:	e8 76 fe ff ff       	call   80106919 <outb>
}
80106aa3:	c9                   	leave  
80106aa4:	c3                   	ret    
...
80106aa8:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80106aab:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
80106ab0:	85 c0                	test   %eax,%eax
80106ab2:	75 07                	jne    80106abb <uartgetc+0x16>
    return -1;
80106ab4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106ab9:	eb 2c                	jmp    80106ae7 <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80106abb:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106ac2:	e8 35 fe ff ff       	call   801068fc <inb>
80106ac7:	0f b6 c0             	movzbl %al,%eax
80106aca:	83 e0 01             	and    $0x1,%eax
80106acd:	85 c0                	test   %eax,%eax
80106acf:	75 07                	jne    80106ad8 <uartgetc+0x33>
    return -1;
80106ad1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106ad6:	eb 0f                	jmp    80106ae7 <uartgetc+0x42>
  return inb(COM1+0);
80106ad8:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106adf:	e8 18 fe ff ff       	call   801068fc <inb>
...
80106aef:	c7 04 24 a5 6a 10 80 	movl   $0x80106aa5,(%esp)
80106af6:	e8 b2 9c ff ff       	call   801007ad <consoleintr>
}
80106afb:	c9                   	leave  
80106afc:	c3                   	ret    
...
80106aff:	6a 00                	push   $0x0
  jmp alltraps
80106b01:	e9 7b f9 ff ff       	jmp    80106481 <alltraps>
...
80106b06:	6a 00                	push   $0x0
  pushl $1
80106b08:	6a 01                	push   $0x1
  jmp alltraps
80106b0a:	e9 72 f9 ff ff       	jmp    80106481 <alltraps>
...
80106b0f:	6a 00                	push   $0x0
  pushl $2
80106b11:	6a 02                	push   $0x2
  jmp alltraps
80106b13:	e9 69 f9 ff ff       	jmp    80106481 <alltraps>
...
80106b18:	6a 00                	push   $0x0
  pushl $3
80106b1a:	6a 03                	push   $0x3
  jmp alltraps
80106b1c:	e9 60 f9 ff ff       	jmp    80106481 <alltraps>
...
80106b21:	6a 00                	push   $0x0
  pushl $4
80106b23:	6a 04                	push   $0x4
  jmp alltraps
80106b25:	e9 57 f9 ff ff       	jmp    80106481 <alltraps>
...
80106b2a:	6a 00                	push   $0x0
  pushl $5
80106b2c:	6a 05                	push   $0x5
  jmp alltraps
80106b2e:	e9 4e f9 ff ff       	jmp    80106481 <alltraps>
...
80106b35:	6a 06                	push   $0x6
  jmp alltraps
80106b37:	e9 45 f9 ff ff       	jmp    80106481 <alltraps>
...
80106b3c:	6a 00                	push   $0x0
  pushl $7
80106b3e:	6a 07                	push   $0x7
  jmp alltraps
80106b40:	e9 3c f9 ff ff       	jmp    80106481 <alltraps>

80106b45 <vector8>:
.globl vector8
vector8:
  pushl $8
80106b45:	6a 08                	push   $0x8
  jmp alltraps
80106b47:	e9 35 f9 ff ff       	jmp    80106481 <alltraps>
...
80106b4c:	6a 00                	push   $0x0
  pushl $9
80106b4e:	6a 09                	push   $0x9
  jmp alltraps
80106b50:	e9 2c f9 ff ff       	jmp    80106481 <alltraps>

80106b55 <vector10>:
.globl vector10
vector10:
  pushl $10
80106b55:	6a 0a                	push   $0xa
  jmp alltraps
80106b57:	e9 25 f9 ff ff       	jmp    80106481 <alltraps>

80106b5c <vector11>:
.globl vector11
vector11:
  pushl $11
80106b5c:	6a 0b                	push   $0xb
  jmp alltraps
80106b5e:	e9 1e f9 ff ff       	jmp    80106481 <alltraps>

80106b63 <vector12>:
.globl vector12
vector12:
  pushl $12
80106b63:	6a 0c                	push   $0xc
  jmp alltraps
80106b65:	e9 17 f9 ff ff       	jmp    80106481 <alltraps>

80106b6a <vector13>:
.globl vector13
vector13:
  pushl $13
80106b6a:	6a 0d                	push   $0xd
  jmp alltraps
80106b6c:	e9 10 f9 ff ff       	jmp    80106481 <alltraps>

80106b71 <vector14>:
.globl vector14
vector14:
  pushl $14
80106b71:	6a 0e                	push   $0xe
  jmp alltraps
80106b73:	e9 09 f9 ff ff       	jmp    80106481 <alltraps>
...
80106b78:	6a 00                	push   $0x0
  pushl $15
80106b7a:	6a 0f                	push   $0xf
  jmp alltraps
80106b7c:	e9 00 f9 ff ff       	jmp    80106481 <alltraps>
...
80106b83:	6a 10                	push   $0x10
  jmp alltraps
80106b85:	e9 f7 f8 ff ff       	jmp    80106481 <alltraps>

80106b8a <vector17>:
.globl vector17
vector17:
  pushl $17
80106b8a:	6a 11                	push   $0x11
  jmp alltraps
80106b8c:	e9 f0 f8 ff ff       	jmp    80106481 <alltraps>
...
80106b91:	6a 00                	push   $0x0
  pushl $18
80106b93:	6a 12                	push   $0x12
  jmp alltraps
80106b95:	e9 e7 f8 ff ff       	jmp    80106481 <alltraps>
...
80106b9a:	6a 00                	push   $0x0
  pushl $19
80106b9c:	6a 13                	push   $0x13
  jmp alltraps
80106b9e:	e9 de f8 ff ff       	jmp    80106481 <alltraps>
...
80106ba3:	6a 00                	push   $0x0
  pushl $20
80106ba5:	6a 14                	push   $0x14
  jmp alltraps
80106ba7:	e9 d5 f8 ff ff       	jmp    80106481 <alltraps>
...
80106bac:	6a 00                	push   $0x0
  pushl $21
80106bae:	6a 15                	push   $0x15
  jmp alltraps
80106bb0:	e9 cc f8 ff ff       	jmp    80106481 <alltraps>
...
80106bb5:	6a 00                	push   $0x0
  pushl $22
80106bb7:	6a 16                	push   $0x16
  jmp alltraps
80106bb9:	e9 c3 f8 ff ff       	jmp    80106481 <alltraps>
...
80106bbe:	6a 00                	push   $0x0
  pushl $23
80106bc0:	6a 17                	push   $0x17
  jmp alltraps
80106bc2:	e9 ba f8 ff ff       	jmp    80106481 <alltraps>
...
80106bc7:	6a 00                	push   $0x0
  pushl $24
80106bc9:	6a 18                	push   $0x18
  jmp alltraps
80106bcb:	e9 b1 f8 ff ff       	jmp    80106481 <alltraps>
...
80106bd0:	6a 00                	push   $0x0
  pushl $25
80106bd2:	6a 19                	push   $0x19
  jmp alltraps
80106bd4:	e9 a8 f8 ff ff       	jmp    80106481 <alltraps>
...
80106bd9:	6a 00                	push   $0x0
  pushl $26
80106bdb:	6a 1a                	push   $0x1a
  jmp alltraps
80106bdd:	e9 9f f8 ff ff       	jmp    80106481 <alltraps>
...
80106be2:	6a 00                	push   $0x0
  pushl $27
80106be4:	6a 1b                	push   $0x1b
  jmp alltraps
80106be6:	e9 96 f8 ff ff       	jmp    80106481 <alltraps>
...
80106beb:	6a 00                	push   $0x0
  pushl $28
80106bed:	6a 1c                	push   $0x1c
  jmp alltraps
80106bef:	e9 8d f8 ff ff       	jmp    80106481 <alltraps>
...
80106bf4:	6a 00                	push   $0x0
  pushl $29
80106bf6:	6a 1d                	push   $0x1d
  jmp alltraps
80106bf8:	e9 84 f8 ff ff       	jmp    80106481 <alltraps>
...
80106bfd:	6a 00                	push   $0x0
  pushl $30
80106bff:	6a 1e                	push   $0x1e
  jmp alltraps
80106c01:	e9 7b f8 ff ff       	jmp    80106481 <alltraps>
...
80106c06:	6a 00                	push   $0x0
  pushl $31
80106c08:	6a 1f                	push   $0x1f
  jmp alltraps
80106c0a:	e9 72 f8 ff ff       	jmp    80106481 <alltraps>
...
80106c0f:	6a 00                	push   $0x0
  pushl $32
80106c11:	6a 20                	push   $0x20
  jmp alltraps
80106c13:	e9 69 f8 ff ff       	jmp    80106481 <alltraps>
...
80106c18:	6a 00                	push   $0x0
  pushl $33
80106c1a:	6a 21                	push   $0x21
  jmp alltraps
80106c1c:	e9 60 f8 ff ff       	jmp    80106481 <alltraps>
...
80106c21:	6a 00                	push   $0x0
  pushl $34
80106c23:	6a 22                	push   $0x22
  jmp alltraps
80106c25:	e9 57 f8 ff ff       	jmp    80106481 <alltraps>
...
80106c2a:	6a 00                	push   $0x0
  pushl $35
80106c2c:	6a 23                	push   $0x23
  jmp alltraps
80106c2e:	e9 4e f8 ff ff       	jmp    80106481 <alltraps>
...
80106c33:	6a 00                	push   $0x0
  pushl $36
80106c35:	6a 24                	push   $0x24
  jmp alltraps
80106c37:	e9 45 f8 ff ff       	jmp    80106481 <alltraps>
...
80106c3c:	6a 00                	push   $0x0
  pushl $37
80106c3e:	6a 25                	push   $0x25
  jmp alltraps
80106c40:	e9 3c f8 ff ff       	jmp    80106481 <alltraps>
...
80106c45:	6a 00                	push   $0x0
  pushl $38
80106c47:	6a 26                	push   $0x26
  jmp alltraps
80106c49:	e9 33 f8 ff ff       	jmp    80106481 <alltraps>
...
80106c4e:	6a 00                	push   $0x0
  pushl $39
80106c50:	6a 27                	push   $0x27
  jmp alltraps
80106c52:	e9 2a f8 ff ff       	jmp    80106481 <alltraps>
...
80106c57:	6a 00                	push   $0x0
  pushl $40
80106c59:	6a 28                	push   $0x28
  jmp alltraps
80106c5b:	e9 21 f8 ff ff       	jmp    80106481 <alltraps>
...
80106c60:	6a 00                	push   $0x0
  pushl $41
80106c62:	6a 29                	push   $0x29
  jmp alltraps
80106c64:	e9 18 f8 ff ff       	jmp    80106481 <alltraps>
...
80106c69:	6a 00                	push   $0x0
  pushl $42
80106c6b:	6a 2a                	push   $0x2a
  jmp alltraps
80106c6d:	e9 0f f8 ff ff       	jmp    80106481 <alltraps>
...
80106c72:	6a 00                	push   $0x0
  pushl $43
80106c74:	6a 2b                	push   $0x2b
  jmp alltraps
80106c76:	e9 06 f8 ff ff       	jmp    80106481 <alltraps>
...
80106c7b:	6a 00                	push   $0x0
  pushl $44
80106c7d:	6a 2c                	push   $0x2c
  jmp alltraps
80106c7f:	e9 fd f7 ff ff       	jmp    80106481 <alltraps>
...
80106c84:	6a 00                	push   $0x0
  pushl $45
80106c86:	6a 2d                	push   $0x2d
  jmp alltraps
80106c88:	e9 f4 f7 ff ff       	jmp    80106481 <alltraps>
...
80106c8d:	6a 00                	push   $0x0
  pushl $46
80106c8f:	6a 2e                	push   $0x2e
  jmp alltraps
80106c91:	e9 eb f7 ff ff       	jmp    80106481 <alltraps>
...
80106c96:	6a 00                	push   $0x0
  pushl $47
80106c98:	6a 2f                	push   $0x2f
  jmp alltraps
80106c9a:	e9 e2 f7 ff ff       	jmp    80106481 <alltraps>
...
80106c9f:	6a 00                	push   $0x0
  pushl $48
80106ca1:	6a 30                	push   $0x30
  jmp alltraps
80106ca3:	e9 d9 f7 ff ff       	jmp    80106481 <alltraps>
...
80106ca8:	6a 00                	push   $0x0
  pushl $49
80106caa:	6a 31                	push   $0x31
  jmp alltraps
80106cac:	e9 d0 f7 ff ff       	jmp    80106481 <alltraps>
...
80106cb1:	6a 00                	push   $0x0
  pushl $50
80106cb3:	6a 32                	push   $0x32
  jmp alltraps
80106cb5:	e9 c7 f7 ff ff       	jmp    80106481 <alltraps>
...
80106cba:	6a 00                	push   $0x0
  pushl $51
80106cbc:	6a 33                	push   $0x33
  jmp alltraps
80106cbe:	e9 be f7 ff ff       	jmp    80106481 <alltraps>
...
80106cc5:	6a 34                	push   $0x34
  jmp alltraps
80106cc7:	e9 b5 f7 ff ff       	jmp    80106481 <alltraps>
...
80106ccc:	6a 00                	push   $0x0
  pushl $53
80106cce:	6a 35                	push   $0x35
  jmp alltraps
80106cd0:	e9 ac f7 ff ff       	jmp    80106481 <alltraps>
...
80106cd5:	6a 00                	push   $0x0
  pushl $54
80106cd7:	6a 36                	push   $0x36
  jmp alltraps
80106cd9:	e9 a3 f7 ff ff       	jmp    80106481 <alltraps>
...
80106cde:	6a 00                	push   $0x0
  pushl $55
80106ce0:	6a 37                	push   $0x37
  jmp alltraps
80106ce2:	e9 9a f7 ff ff       	jmp    80106481 <alltraps>
...
80106ce7:	6a 00                	push   $0x0
  pushl $56
80106ce9:	6a 38                	push   $0x38
  jmp alltraps
80106ceb:	e9 91 f7 ff ff       	jmp    80106481 <alltraps>
...
80106cf0:	6a 00                	push   $0x0
  pushl $57
80106cf2:	6a 39                	push   $0x39
  jmp alltraps
80106cf4:	e9 88 f7 ff ff       	jmp    80106481 <alltraps>
...
80106cf9:	6a 00                	push   $0x0
  pushl $58
80106cfb:	6a 3a                	push   $0x3a
  jmp alltraps
80106cfd:	e9 7f f7 ff ff       	jmp    80106481 <alltraps>
...
80106d02:	6a 00                	push   $0x0
  pushl $59
80106d04:	6a 3b                	push   $0x3b
  jmp alltraps
80106d06:	e9 76 f7 ff ff       	jmp    80106481 <alltraps>
...
80106d0b:	6a 00                	push   $0x0
  pushl $60
80106d0d:	6a 3c                	push   $0x3c
  jmp alltraps
80106d0f:	e9 6d f7 ff ff       	jmp    80106481 <alltraps>
...
80106d14:	6a 00                	push   $0x0
  pushl $61
80106d16:	6a 3d                	push   $0x3d
  jmp alltraps
80106d18:	e9 64 f7 ff ff       	jmp    80106481 <alltraps>
...
80106d1d:	6a 00                	push   $0x0
  pushl $62
80106d1f:	6a 3e                	push   $0x3e
  jmp alltraps
80106d21:	e9 5b f7 ff ff       	jmp    80106481 <alltraps>
...
80106d26:	6a 00                	push   $0x0
  pushl $63
80106d28:	6a 3f                	push   $0x3f
  jmp alltraps
80106d2a:	e9 52 f7 ff ff       	jmp    80106481 <alltraps>
...
80106d2f:	6a 00                	push   $0x0
  pushl $64
80106d31:	6a 40                	push   $0x40
  jmp alltraps
80106d33:	e9 49 f7 ff ff       	jmp    80106481 <alltraps>
...
80106d38:	6a 00                	push   $0x0
  pushl $65
80106d3a:	6a 41                	push   $0x41
  jmp alltraps
80106d3c:	e9 40 f7 ff ff       	jmp    80106481 <alltraps>
...
80106d41:	6a 00                	push   $0x0
  pushl $66
80106d43:	6a 42                	push   $0x42
  jmp alltraps
80106d45:	e9 37 f7 ff ff       	jmp    80106481 <alltraps>
...
80106d4a:	6a 00                	push   $0x0
  pushl $67
80106d4c:	6a 43                	push   $0x43
  jmp alltraps
80106d4e:	e9 2e f7 ff ff       	jmp    80106481 <alltraps>
...
80106d53:	6a 00                	push   $0x0
  pushl $68
80106d55:	6a 44                	push   $0x44
  jmp alltraps
80106d57:	e9 25 f7 ff ff       	jmp    80106481 <alltraps>
...
80106d5c:	6a 00                	push   $0x0
  pushl $69
80106d5e:	6a 45                	push   $0x45
  jmp alltraps
80106d60:	e9 1c f7 ff ff       	jmp    80106481 <alltraps>
...
80106d65:	6a 00                	push   $0x0
  pushl $70
80106d67:	6a 46                	push   $0x46
  jmp alltraps
80106d69:	e9 13 f7 ff ff       	jmp    80106481 <alltraps>
...
80106d6e:	6a 00                	push   $0x0
  pushl $71
80106d70:	6a 47                	push   $0x47
  jmp alltraps
80106d72:	e9 0a f7 ff ff       	jmp    80106481 <alltraps>
...
80106d77:	6a 00                	push   $0x0
  pushl $72
80106d79:	6a 48                	push   $0x48
  jmp alltraps
80106d7b:	e9 01 f7 ff ff       	jmp    80106481 <alltraps>
...
80106d80:	6a 00                	push   $0x0
  pushl $73
80106d82:	6a 49                	push   $0x49
  jmp alltraps
80106d84:	e9 f8 f6 ff ff       	jmp    80106481 <alltraps>
...
80106d89:	6a 00                	push   $0x0
  pushl $74
80106d8b:	6a 4a                	push   $0x4a
  jmp alltraps
80106d8d:	e9 ef f6 ff ff       	jmp    80106481 <alltraps>
...
80106d92:	6a 00                	push   $0x0
  pushl $75
80106d94:	6a 4b                	push   $0x4b
  jmp alltraps
80106d96:	e9 e6 f6 ff ff       	jmp    80106481 <alltraps>
...
80106d9b:	6a 00                	push   $0x0
  pushl $76
80106d9d:	6a 4c                	push   $0x4c
  jmp alltraps
80106d9f:	e9 dd f6 ff ff       	jmp    80106481 <alltraps>
...
80106da4:	6a 00                	push   $0x0
  pushl $77
80106da6:	6a 4d                	push   $0x4d
  jmp alltraps
80106da8:	e9 d4 f6 ff ff       	jmp    80106481 <alltraps>
...
80106dad:	6a 00                	push   $0x0
  pushl $78
80106daf:	6a 4e                	push   $0x4e
  jmp alltraps
80106db1:	e9 cb f6 ff ff       	jmp    80106481 <alltraps>
...
80106db6:	6a 00                	push   $0x0
  pushl $79
80106db8:	6a 4f                	push   $0x4f
  jmp alltraps
80106dba:	e9 c2 f6 ff ff       	jmp    80106481 <alltraps>
...
80106dbf:	6a 00                	push   $0x0
  pushl $80
80106dc1:	6a 50                	push   $0x50
  jmp alltraps
80106dc3:	e9 b9 f6 ff ff       	jmp    80106481 <alltraps>
...
80106dc8:	6a 00                	push   $0x0
  pushl $81
80106dca:	6a 51                	push   $0x51
  jmp alltraps
80106dcc:	e9 b0 f6 ff ff       	jmp    80106481 <alltraps>
...
80106dd1:	6a 00                	push   $0x0
  pushl $82
80106dd3:	6a 52                	push   $0x52
  jmp alltraps
80106dd5:	e9 a7 f6 ff ff       	jmp    80106481 <alltraps>
...
80106dda:	6a 00                	push   $0x0
  pushl $83
80106ddc:	6a 53                	push   $0x53
  jmp alltraps
80106dde:	e9 9e f6 ff ff       	jmp    80106481 <alltraps>
...
80106de3:	6a 00                	push   $0x0
  pushl $84
80106de5:	6a 54                	push   $0x54
  jmp alltraps
80106de7:	e9 95 f6 ff ff       	jmp    80106481 <alltraps>
...
80106dec:	6a 00                	push   $0x0
  pushl $85
80106dee:	6a 55                	push   $0x55
  jmp alltraps
80106df0:	e9 8c f6 ff ff       	jmp    80106481 <alltraps>
...
80106df5:	6a 00                	push   $0x0
  pushl $86
80106df7:	6a 56                	push   $0x56
  jmp alltraps
80106df9:	e9 83 f6 ff ff       	jmp    80106481 <alltraps>
...
80106dfe:	6a 00                	push   $0x0
  pushl $87
80106e00:	6a 57                	push   $0x57
  jmp alltraps
80106e02:	e9 7a f6 ff ff       	jmp    80106481 <alltraps>
...
80106e07:	6a 00                	push   $0x0
  pushl $88
80106e09:	6a 58                	push   $0x58
  jmp alltraps
80106e0b:	e9 71 f6 ff ff       	jmp    80106481 <alltraps>
...
80106e10:	6a 00                	push   $0x0
  pushl $89
80106e12:	6a 59                	push   $0x59
  jmp alltraps
80106e14:	e9 68 f6 ff ff       	jmp    80106481 <alltraps>
...
80106e19:	6a 00                	push   $0x0
  pushl $90
80106e1b:	6a 5a                	push   $0x5a
  jmp alltraps
80106e1d:	e9 5f f6 ff ff       	jmp    80106481 <alltraps>
...
80106e22:	6a 00                	push   $0x0
  pushl $91
80106e24:	6a 5b                	push   $0x5b
  jmp alltraps
80106e26:	e9 56 f6 ff ff       	jmp    80106481 <alltraps>
...
80106e2b:	6a 00                	push   $0x0
  pushl $92
80106e2d:	6a 5c                	push   $0x5c
  jmp alltraps
80106e2f:	e9 4d f6 ff ff       	jmp    80106481 <alltraps>
...
80106e34:	6a 00                	push   $0x0
  pushl $93
80106e36:	6a 5d                	push   $0x5d
  jmp alltraps
80106e38:	e9 44 f6 ff ff       	jmp    80106481 <alltraps>
...
80106e3d:	6a 00                	push   $0x0
  pushl $94
80106e3f:	6a 5e                	push   $0x5e
  jmp alltraps
80106e41:	e9 3b f6 ff ff       	jmp    80106481 <alltraps>
...
80106e46:	6a 00                	push   $0x0
  pushl $95
80106e48:	6a 5f                	push   $0x5f
  jmp alltraps
80106e4a:	e9 32 f6 ff ff       	jmp    80106481 <alltraps>
...
80106e4f:	6a 00                	push   $0x0
  pushl $96
80106e51:	6a 60                	push   $0x60
  jmp alltraps
80106e53:	e9 29 f6 ff ff       	jmp    80106481 <alltraps>
...
80106e58:	6a 00                	push   $0x0
  pushl $97
80106e5a:	6a 61                	push   $0x61
  jmp alltraps
80106e5c:	e9 20 f6 ff ff       	jmp    80106481 <alltraps>
...
80106e61:	6a 00                	push   $0x0
  pushl $98
80106e63:	6a 62                	push   $0x62
  jmp alltraps
80106e65:	e9 17 f6 ff ff       	jmp    80106481 <alltraps>
...
80106e6a:	6a 00                	push   $0x0
  pushl $99
80106e6c:	6a 63                	push   $0x63
  jmp alltraps
80106e6e:	e9 0e f6 ff ff       	jmp    80106481 <alltraps>
...
80106e73:	6a 00                	push   $0x0
  pushl $100
80106e75:	6a 64                	push   $0x64
  jmp alltraps
80106e77:	e9 05 f6 ff ff       	jmp    80106481 <alltraps>
...
80106e7c:	6a 00                	push   $0x0
  pushl $101
80106e7e:	6a 65                	push   $0x65
  jmp alltraps
80106e80:	e9 fc f5 ff ff       	jmp    80106481 <alltraps>
...
80106e85:	6a 00                	push   $0x0
  pushl $102
80106e87:	6a 66                	push   $0x66
  jmp alltraps
80106e89:	e9 f3 f5 ff ff       	jmp    80106481 <alltraps>
...
80106e8e:	6a 00                	push   $0x0
  pushl $103
80106e90:	6a 67                	push   $0x67
  jmp alltraps
80106e92:	e9 ea f5 ff ff       	jmp    80106481 <alltraps>
...
80106e97:	6a 00                	push   $0x0
  pushl $104
80106e99:	6a 68                	push   $0x68
  jmp alltraps
80106e9b:	e9 e1 f5 ff ff       	jmp    80106481 <alltraps>
...
80106ea0:	6a 00                	push   $0x0
  pushl $105
80106ea2:	6a 69                	push   $0x69
  jmp alltraps
80106ea4:	e9 d8 f5 ff ff       	jmp    80106481 <alltraps>
...
80106ea9:	6a 00                	push   $0x0
  pushl $106
80106eab:	6a 6a                	push   $0x6a
  jmp alltraps
80106ead:	e9 cf f5 ff ff       	jmp    80106481 <alltraps>
...
80106eb2:	6a 00                	push   $0x0
  pushl $107
80106eb4:	6a 6b                	push   $0x6b
  jmp alltraps
80106eb6:	e9 c6 f5 ff ff       	jmp    80106481 <alltraps>
...
80106ebb:	6a 00                	push   $0x0
  pushl $108
80106ebd:	6a 6c                	push   $0x6c
  jmp alltraps
80106ebf:	e9 bd f5 ff ff       	jmp    80106481 <alltraps>
...
80106ec4:	6a 00                	push   $0x0
  pushl $109
80106ec6:	6a 6d                	push   $0x6d
  jmp alltraps
80106ec8:	e9 b4 f5 ff ff       	jmp    80106481 <alltraps>
...
80106ecd:	6a 00                	push   $0x0
  pushl $110
80106ecf:	6a 6e                	push   $0x6e
  jmp alltraps
80106ed1:	e9 ab f5 ff ff       	jmp    80106481 <alltraps>
...
80106ed6:	6a 00                	push   $0x0
  pushl $111
80106ed8:	6a 6f                	push   $0x6f
  jmp alltraps
80106eda:	e9 a2 f5 ff ff       	jmp    80106481 <alltraps>
...
80106edf:	6a 00                	push   $0x0
  pushl $112
80106ee1:	6a 70                	push   $0x70
  jmp alltraps
80106ee3:	e9 99 f5 ff ff       	jmp    80106481 <alltraps>
...
80106ee8:	6a 00                	push   $0x0
  pushl $113
80106eea:	6a 71                	push   $0x71
  jmp alltraps
80106eec:	e9 90 f5 ff ff       	jmp    80106481 <alltraps>
...
80106ef1:	6a 00                	push   $0x0
  pushl $114
80106ef3:	6a 72                	push   $0x72
  jmp alltraps
80106ef5:	e9 87 f5 ff ff       	jmp    80106481 <alltraps>
...
80106efa:	6a 00                	push   $0x0
  pushl $115
80106efc:	6a 73                	push   $0x73
  jmp alltraps
80106efe:	e9 7e f5 ff ff       	jmp    80106481 <alltraps>
...
80106f03:	6a 00                	push   $0x0
  pushl $116
80106f05:	6a 74                	push   $0x74
  jmp alltraps
80106f07:	e9 75 f5 ff ff       	jmp    80106481 <alltraps>
...
80106f0c:	6a 00                	push   $0x0
  pushl $117
80106f0e:	6a 75                	push   $0x75
  jmp alltraps
80106f10:	e9 6c f5 ff ff       	jmp    80106481 <alltraps>
...
80106f15:	6a 00                	push   $0x0
  pushl $118
80106f17:	6a 76                	push   $0x76
  jmp alltraps
80106f19:	e9 63 f5 ff ff       	jmp    80106481 <alltraps>
...
80106f1e:	6a 00                	push   $0x0
  pushl $119
80106f20:	6a 77                	push   $0x77
  jmp alltraps
80106f22:	e9 5a f5 ff ff       	jmp    80106481 <alltraps>
...
80106f27:	6a 00                	push   $0x0
  pushl $120
80106f29:	6a 78                	push   $0x78
  jmp alltraps
80106f2b:	e9 51 f5 ff ff       	jmp    80106481 <alltraps>
...
80106f30:	6a 00                	push   $0x0
  pushl $121
80106f32:	6a 79                	push   $0x79
  jmp alltraps
80106f34:	e9 48 f5 ff ff       	jmp    80106481 <alltraps>
...
80106f39:	6a 00                	push   $0x0
  pushl $122
80106f3b:	6a 7a                	push   $0x7a
  jmp alltraps
80106f3d:	e9 3f f5 ff ff       	jmp    80106481 <alltraps>
...
80106f42:	6a 00                	push   $0x0
  pushl $123
80106f44:	6a 7b                	push   $0x7b
  jmp alltraps
80106f46:	e9 36 f5 ff ff       	jmp    80106481 <alltraps>
...
80106f4b:	6a 00                	push   $0x0
  pushl $124
80106f4d:	6a 7c                	push   $0x7c
  jmp alltraps
80106f4f:	e9 2d f5 ff ff       	jmp    80106481 <alltraps>
...
80106f54:	6a 00                	push   $0x0
  pushl $125
80106f56:	6a 7d                	push   $0x7d
  jmp alltraps
80106f58:	e9 24 f5 ff ff       	jmp    80106481 <alltraps>
...
80106f5d:	6a 00                	push   $0x0
  pushl $126
80106f5f:	6a 7e                	push   $0x7e
  jmp alltraps
80106f61:	e9 1b f5 ff ff       	jmp    80106481 <alltraps>
...
80106f66:	6a 00                	push   $0x0
  pushl $127
80106f68:	6a 7f                	push   $0x7f
  jmp alltraps
80106f6a:	e9 12 f5 ff ff       	jmp    80106481 <alltraps>
...
80106f6f:	6a 00                	push   $0x0
  pushl $128
80106f71:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106f76:	e9 06 f5 ff ff       	jmp    80106481 <alltraps>
...
80106f7b:	6a 00                	push   $0x0
  pushl $129
80106f7d:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106f82:	e9 fa f4 ff ff       	jmp    80106481 <alltraps>
...
80106f87:	6a 00                	push   $0x0
  pushl $130
80106f89:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106f8e:	e9 ee f4 ff ff       	jmp    80106481 <alltraps>
...
80106f93:	6a 00                	push   $0x0
  pushl $131
80106f95:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106f9a:	e9 e2 f4 ff ff       	jmp    80106481 <alltraps>
...
80106f9f:	6a 00                	push   $0x0
  pushl $132
80106fa1:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106fa6:	e9 d6 f4 ff ff       	jmp    80106481 <alltraps>
...
80106fab:	6a 00                	push   $0x0
  pushl $133
80106fad:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106fb2:	e9 ca f4 ff ff       	jmp    80106481 <alltraps>
...
80106fb7:	6a 00                	push   $0x0
  pushl $134
80106fb9:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106fbe:	e9 be f4 ff ff       	jmp    80106481 <alltraps>
...
80106fc3:	6a 00                	push   $0x0
  pushl $135
80106fc5:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106fca:	e9 b2 f4 ff ff       	jmp    80106481 <alltraps>
...
80106fcf:	6a 00                	push   $0x0
  pushl $136
80106fd1:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106fd6:	e9 a6 f4 ff ff       	jmp    80106481 <alltraps>
...
80106fdb:	6a 00                	push   $0x0
  pushl $137
80106fdd:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106fe2:	e9 9a f4 ff ff       	jmp    80106481 <alltraps>
...
80106fe7:	6a 00                	push   $0x0
  pushl $138
80106fe9:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106fee:	e9 8e f4 ff ff       	jmp    80106481 <alltraps>
...
80106ff3:	6a 00                	push   $0x0
  pushl $139
80106ff5:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106ffa:	e9 82 f4 ff ff       	jmp    80106481 <alltraps>
...
80106fff:	6a 00                	push   $0x0
  pushl $140
80107001:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80107006:	e9 76 f4 ff ff       	jmp    80106481 <alltraps>
...
8010700b:	6a 00                	push   $0x0
  pushl $141
8010700d:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80107012:	e9 6a f4 ff ff       	jmp    80106481 <alltraps>
...
80107017:	6a 00                	push   $0x0
  pushl $142
80107019:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010701e:	e9 5e f4 ff ff       	jmp    80106481 <alltraps>
...
80107023:	6a 00                	push   $0x0
  pushl $143
80107025:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
8010702a:	e9 52 f4 ff ff       	jmp    80106481 <alltraps>
...
8010702f:	6a 00                	push   $0x0
  pushl $144
80107031:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80107036:	e9 46 f4 ff ff       	jmp    80106481 <alltraps>
...
8010703b:	6a 00                	push   $0x0
  pushl $145
8010703d:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80107042:	e9 3a f4 ff ff       	jmp    80106481 <alltraps>
...
80107047:	6a 00                	push   $0x0
  pushl $146
80107049:	68 92 00 00 00       	push   $0x92
  jmp alltraps
8010704e:	e9 2e f4 ff ff       	jmp    80106481 <alltraps>
...
80107053:	6a 00                	push   $0x0
  pushl $147
80107055:	68 93 00 00 00       	push   $0x93
  jmp alltraps
8010705a:	e9 22 f4 ff ff       	jmp    80106481 <alltraps>
...
8010705f:	6a 00                	push   $0x0
  pushl $148
80107061:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80107066:	e9 16 f4 ff ff       	jmp    80106481 <alltraps>
...
8010706b:	6a 00                	push   $0x0
  pushl $149
8010706d:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80107072:	e9 0a f4 ff ff       	jmp    80106481 <alltraps>
...
80107077:	6a 00                	push   $0x0
  pushl $150
80107079:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010707e:	e9 fe f3 ff ff       	jmp    80106481 <alltraps>
...
80107083:	6a 00                	push   $0x0
  pushl $151
80107085:	68 97 00 00 00       	push   $0x97
  jmp alltraps
8010708a:	e9 f2 f3 ff ff       	jmp    80106481 <alltraps>
...
8010708f:	6a 00                	push   $0x0
  pushl $152
80107091:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80107096:	e9 e6 f3 ff ff       	jmp    80106481 <alltraps>
...
8010709b:	6a 00                	push   $0x0
  pushl $153
8010709d:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801070a2:	e9 da f3 ff ff       	jmp    80106481 <alltraps>
...
801070a7:	6a 00                	push   $0x0
  pushl $154
801070a9:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801070ae:	e9 ce f3 ff ff       	jmp    80106481 <alltraps>
...
801070b3:	6a 00                	push   $0x0
  pushl $155
801070b5:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801070ba:	e9 c2 f3 ff ff       	jmp    80106481 <alltraps>
...
801070bf:	6a 00                	push   $0x0
  pushl $156
801070c1:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801070c6:	e9 b6 f3 ff ff       	jmp    80106481 <alltraps>
...
801070cb:	6a 00                	push   $0x0
  pushl $157
801070cd:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801070d2:	e9 aa f3 ff ff       	jmp    80106481 <alltraps>
...
801070d7:	6a 00                	push   $0x0
  pushl $158
801070d9:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801070de:	e9 9e f3 ff ff       	jmp    80106481 <alltraps>
...
801070e3:	6a 00                	push   $0x0
  pushl $159
801070e5:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801070ea:	e9 92 f3 ff ff       	jmp    80106481 <alltraps>
...
801070ef:	6a 00                	push   $0x0
  pushl $160
801070f1:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801070f6:	e9 86 f3 ff ff       	jmp    80106481 <alltraps>
...
801070fb:	6a 00                	push   $0x0
  pushl $161
801070fd:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80107102:	e9 7a f3 ff ff       	jmp    80106481 <alltraps>
...
80107107:	6a 00                	push   $0x0
  pushl $162
80107109:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010710e:	e9 6e f3 ff ff       	jmp    80106481 <alltraps>
...
80107113:	6a 00                	push   $0x0
  pushl $163
80107115:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
8010711a:	e9 62 f3 ff ff       	jmp    80106481 <alltraps>
...
8010711f:	6a 00                	push   $0x0
  pushl $164
80107121:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107126:	e9 56 f3 ff ff       	jmp    80106481 <alltraps>
...
8010712b:	6a 00                	push   $0x0
  pushl $165
8010712d:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80107132:	e9 4a f3 ff ff       	jmp    80106481 <alltraps>
...
80107137:	6a 00                	push   $0x0
  pushl $166
80107139:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
8010713e:	e9 3e f3 ff ff       	jmp    80106481 <alltraps>
...
80107143:	6a 00                	push   $0x0
  pushl $167
80107145:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
8010714a:	e9 32 f3 ff ff       	jmp    80106481 <alltraps>
...
8010714f:	6a 00                	push   $0x0
  pushl $168
80107151:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80107156:	e9 26 f3 ff ff       	jmp    80106481 <alltraps>
...
8010715b:	6a 00                	push   $0x0
  pushl $169
8010715d:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80107162:	e9 1a f3 ff ff       	jmp    80106481 <alltraps>
...
80107167:	6a 00                	push   $0x0
  pushl $170
80107169:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010716e:	e9 0e f3 ff ff       	jmp    80106481 <alltraps>
...
80107173:	6a 00                	push   $0x0
  pushl $171
80107175:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
8010717a:	e9 02 f3 ff ff       	jmp    80106481 <alltraps>
...
8010717f:	6a 00                	push   $0x0
  pushl $172
80107181:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80107186:	e9 f6 f2 ff ff       	jmp    80106481 <alltraps>
...
8010718b:	6a 00                	push   $0x0
  pushl $173
8010718d:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80107192:	e9 ea f2 ff ff       	jmp    80106481 <alltraps>
...
80107197:	6a 00                	push   $0x0
  pushl $174
80107199:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010719e:	e9 de f2 ff ff       	jmp    80106481 <alltraps>
...
801071a3:	6a 00                	push   $0x0
  pushl $175
801071a5:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801071aa:	e9 d2 f2 ff ff       	jmp    80106481 <alltraps>
...
801071af:	6a 00                	push   $0x0
  pushl $176
801071b1:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801071b6:	e9 c6 f2 ff ff       	jmp    80106481 <alltraps>
...
801071bb:	6a 00                	push   $0x0
  pushl $177
801071bd:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801071c2:	e9 ba f2 ff ff       	jmp    80106481 <alltraps>
...
801071c7:	6a 00                	push   $0x0
  pushl $178
801071c9:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801071ce:	e9 ae f2 ff ff       	jmp    80106481 <alltraps>
...
801071d3:	6a 00                	push   $0x0
  pushl $179
801071d5:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801071da:	e9 a2 f2 ff ff       	jmp    80106481 <alltraps>
...
801071df:	6a 00                	push   $0x0
  pushl $180
801071e1:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801071e6:	e9 96 f2 ff ff       	jmp    80106481 <alltraps>
...
801071eb:	6a 00                	push   $0x0
  pushl $181
801071ed:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801071f2:	e9 8a f2 ff ff       	jmp    80106481 <alltraps>
...
801071f7:	6a 00                	push   $0x0
  pushl $182
801071f9:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801071fe:	e9 7e f2 ff ff       	jmp    80106481 <alltraps>
...
80107203:	6a 00                	push   $0x0
  pushl $183
80107205:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
8010720a:	e9 72 f2 ff ff       	jmp    80106481 <alltraps>
...
8010720f:	6a 00                	push   $0x0
  pushl $184
80107211:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107216:	e9 66 f2 ff ff       	jmp    80106481 <alltraps>
...
8010721b:	6a 00                	push   $0x0
  pushl $185
8010721d:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107222:	e9 5a f2 ff ff       	jmp    80106481 <alltraps>
...
80107227:	6a 00                	push   $0x0
  pushl $186
80107229:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
8010722e:	e9 4e f2 ff ff       	jmp    80106481 <alltraps>
...
80107233:	6a 00                	push   $0x0
  pushl $187
80107235:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
8010723a:	e9 42 f2 ff ff       	jmp    80106481 <alltraps>
...
8010723f:	6a 00                	push   $0x0
  pushl $188
80107241:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107246:	e9 36 f2 ff ff       	jmp    80106481 <alltraps>
...
8010724b:	6a 00                	push   $0x0
  pushl $189
8010724d:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80107252:	e9 2a f2 ff ff       	jmp    80106481 <alltraps>
...
80107257:	6a 00                	push   $0x0
  pushl $190
80107259:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
8010725e:	e9 1e f2 ff ff       	jmp    80106481 <alltraps>
...
80107263:	6a 00                	push   $0x0
  pushl $191
80107265:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
8010726a:	e9 12 f2 ff ff       	jmp    80106481 <alltraps>
...
8010726f:	6a 00                	push   $0x0
  pushl $192
80107271:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80107276:	e9 06 f2 ff ff       	jmp    80106481 <alltraps>
...
8010727b:	6a 00                	push   $0x0
  pushl $193
8010727d:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80107282:	e9 fa f1 ff ff       	jmp    80106481 <alltraps>
...
80107287:	6a 00                	push   $0x0
  pushl $194
80107289:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
8010728e:	e9 ee f1 ff ff       	jmp    80106481 <alltraps>
...
80107293:	6a 00                	push   $0x0
  pushl $195
80107295:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
8010729a:	e9 e2 f1 ff ff       	jmp    80106481 <alltraps>
...
8010729f:	6a 00                	push   $0x0
  pushl $196
801072a1:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801072a6:	e9 d6 f1 ff ff       	jmp    80106481 <alltraps>
...
801072ab:	6a 00                	push   $0x0
  pushl $197
801072ad:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801072b2:	e9 ca f1 ff ff       	jmp    80106481 <alltraps>
...
801072b7:	6a 00                	push   $0x0
  pushl $198
801072b9:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801072be:	e9 be f1 ff ff       	jmp    80106481 <alltraps>
...
801072c3:	6a 00                	push   $0x0
  pushl $199
801072c5:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801072ca:	e9 b2 f1 ff ff       	jmp    80106481 <alltraps>
...
801072cf:	6a 00                	push   $0x0
  pushl $200
801072d1:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801072d6:	e9 a6 f1 ff ff       	jmp    80106481 <alltraps>
...
801072db:	6a 00                	push   $0x0
  pushl $201
801072dd:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801072e2:	e9 9a f1 ff ff       	jmp    80106481 <alltraps>
...
801072e7:	6a 00                	push   $0x0
  pushl $202
801072e9:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801072ee:	e9 8e f1 ff ff       	jmp    80106481 <alltraps>
...
801072f3:	6a 00                	push   $0x0
  pushl $203
801072f5:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801072fa:	e9 82 f1 ff ff       	jmp    80106481 <alltraps>
...
801072ff:	6a 00                	push   $0x0
  pushl $204
80107301:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107306:	e9 76 f1 ff ff       	jmp    80106481 <alltraps>
...
8010730b:	6a 00                	push   $0x0
  pushl $205
8010730d:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107312:	e9 6a f1 ff ff       	jmp    80106481 <alltraps>
...
80107317:	6a 00                	push   $0x0
  pushl $206
80107319:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
8010731e:	e9 5e f1 ff ff       	jmp    80106481 <alltraps>
...
80107323:	6a 00                	push   $0x0
  pushl $207
80107325:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
8010732a:	e9 52 f1 ff ff       	jmp    80106481 <alltraps>
...
8010732f:	6a 00                	push   $0x0
  pushl $208
80107331:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107336:	e9 46 f1 ff ff       	jmp    80106481 <alltraps>
...
8010733b:	6a 00                	push   $0x0
  pushl $209
8010733d:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107342:	e9 3a f1 ff ff       	jmp    80106481 <alltraps>
...
80107347:	6a 00                	push   $0x0
  pushl $210
80107349:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
8010734e:	e9 2e f1 ff ff       	jmp    80106481 <alltraps>
...
80107353:	6a 00                	push   $0x0
  pushl $211
80107355:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
8010735a:	e9 22 f1 ff ff       	jmp    80106481 <alltraps>
...
8010735f:	6a 00                	push   $0x0
  pushl $212
80107361:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107366:	e9 16 f1 ff ff       	jmp    80106481 <alltraps>
...
8010736b:	6a 00                	push   $0x0
  pushl $213
8010736d:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80107372:	e9 0a f1 ff ff       	jmp    80106481 <alltraps>
...
80107377:	6a 00                	push   $0x0
  pushl $214
80107379:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
8010737e:	e9 fe f0 ff ff       	jmp    80106481 <alltraps>
...
80107383:	6a 00                	push   $0x0
  pushl $215
80107385:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
8010738a:	e9 f2 f0 ff ff       	jmp    80106481 <alltraps>
...
8010738f:	6a 00                	push   $0x0
  pushl $216
80107391:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107396:	e9 e6 f0 ff ff       	jmp    80106481 <alltraps>
...
8010739b:	6a 00                	push   $0x0
  pushl $217
8010739d:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801073a2:	e9 da f0 ff ff       	jmp    80106481 <alltraps>
...
801073a7:	6a 00                	push   $0x0
  pushl $218
801073a9:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801073ae:	e9 ce f0 ff ff       	jmp    80106481 <alltraps>
...
801073b3:	6a 00                	push   $0x0
  pushl $219
801073b5:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801073ba:	e9 c2 f0 ff ff       	jmp    80106481 <alltraps>
...
801073bf:	6a 00                	push   $0x0
  pushl $220
801073c1:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801073c6:	e9 b6 f0 ff ff       	jmp    80106481 <alltraps>
...
801073cb:	6a 00                	push   $0x0
  pushl $221
801073cd:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801073d2:	e9 aa f0 ff ff       	jmp    80106481 <alltraps>
...
801073d7:	6a 00                	push   $0x0
  pushl $222
801073d9:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801073de:	e9 9e f0 ff ff       	jmp    80106481 <alltraps>
...
801073e3:	6a 00                	push   $0x0
  pushl $223
801073e5:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801073ea:	e9 92 f0 ff ff       	jmp    80106481 <alltraps>
...
801073ef:	6a 00                	push   $0x0
  pushl $224
801073f1:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801073f6:	e9 86 f0 ff ff       	jmp    80106481 <alltraps>
...
801073fb:	6a 00                	push   $0x0
  pushl $225
801073fd:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107402:	e9 7a f0 ff ff       	jmp    80106481 <alltraps>
...
80107407:	6a 00                	push   $0x0
  pushl $226
80107409:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
8010740e:	e9 6e f0 ff ff       	jmp    80106481 <alltraps>
...
80107413:	6a 00                	push   $0x0
  pushl $227
80107415:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
8010741a:	e9 62 f0 ff ff       	jmp    80106481 <alltraps>
...
8010741f:	6a 00                	push   $0x0
  pushl $228
80107421:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107426:	e9 56 f0 ff ff       	jmp    80106481 <alltraps>
...
8010742b:	6a 00                	push   $0x0
  pushl $229
8010742d:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107432:	e9 4a f0 ff ff       	jmp    80106481 <alltraps>
...
80107437:	6a 00                	push   $0x0
  pushl $230
80107439:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
8010743e:	e9 3e f0 ff ff       	jmp    80106481 <alltraps>
...
80107443:	6a 00                	push   $0x0
  pushl $231
80107445:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
8010744a:	e9 32 f0 ff ff       	jmp    80106481 <alltraps>
...
8010744f:	6a 00                	push   $0x0
  pushl $232
80107451:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107456:	e9 26 f0 ff ff       	jmp    80106481 <alltraps>
...
8010745b:	6a 00                	push   $0x0
  pushl $233
8010745d:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107462:	e9 1a f0 ff ff       	jmp    80106481 <alltraps>
...
80107467:	6a 00                	push   $0x0
  pushl $234
80107469:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
8010746e:	e9 0e f0 ff ff       	jmp    80106481 <alltraps>
...
80107473:	6a 00                	push   $0x0
  pushl $235
80107475:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
8010747a:	e9 02 f0 ff ff       	jmp    80106481 <alltraps>
...
8010747f:	6a 00                	push   $0x0
  pushl $236
80107481:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107486:	e9 f6 ef ff ff       	jmp    80106481 <alltraps>
...
8010748b:	6a 00                	push   $0x0
  pushl $237
8010748d:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107492:	e9 ea ef ff ff       	jmp    80106481 <alltraps>
...
80107497:	6a 00                	push   $0x0
  pushl $238
80107499:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
8010749e:	e9 de ef ff ff       	jmp    80106481 <alltraps>
...
801074a3:	6a 00                	push   $0x0
  pushl $239
801074a5:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801074aa:	e9 d2 ef ff ff       	jmp    80106481 <alltraps>
...
801074af:	6a 00                	push   $0x0
  pushl $240
801074b1:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801074b6:	e9 c6 ef ff ff       	jmp    80106481 <alltraps>
...
801074bb:	6a 00                	push   $0x0
  pushl $241
801074bd:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801074c2:	e9 ba ef ff ff       	jmp    80106481 <alltraps>
...
801074c7:	6a 00                	push   $0x0
  pushl $242
801074c9:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801074ce:	e9 ae ef ff ff       	jmp    80106481 <alltraps>
...
801074d3:	6a 00                	push   $0x0
  pushl $243
801074d5:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801074da:	e9 a2 ef ff ff       	jmp    80106481 <alltraps>
...
801074df:	6a 00                	push   $0x0
  pushl $244
801074e1:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801074e6:	e9 96 ef ff ff       	jmp    80106481 <alltraps>
...
801074eb:	6a 00                	push   $0x0
  pushl $245
801074ed:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801074f2:	e9 8a ef ff ff       	jmp    80106481 <alltraps>
...
801074f7:	6a 00                	push   $0x0
  pushl $246
801074f9:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801074fe:	e9 7e ef ff ff       	jmp    80106481 <alltraps>
...
80107503:	6a 00                	push   $0x0
  pushl $247
80107505:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
8010750a:	e9 72 ef ff ff       	jmp    80106481 <alltraps>
...
8010750f:	6a 00                	push   $0x0
  pushl $248
80107511:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107516:	e9 66 ef ff ff       	jmp    80106481 <alltraps>
...
8010751b:	6a 00                	push   $0x0
  pushl $249
8010751d:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107522:	e9 5a ef ff ff       	jmp    80106481 <alltraps>
...
80107527:	6a 00                	push   $0x0
  pushl $250
80107529:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
8010752e:	e9 4e ef ff ff       	jmp    80106481 <alltraps>
...
80107533:	6a 00                	push   $0x0
  pushl $251
80107535:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
8010753a:	e9 42 ef ff ff       	jmp    80106481 <alltraps>
...
8010753f:	6a 00                	push   $0x0
  pushl $252
80107541:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107546:	e9 36 ef ff ff       	jmp    80106481 <alltraps>
...
8010754b:	6a 00                	push   $0x0
  pushl $253
8010754d:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107552:	e9 2a ef ff ff       	jmp    80106481 <alltraps>
...
80107557:	6a 00                	push   $0x0
  pushl $254
80107559:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
8010755e:	e9 1e ef ff ff       	jmp    80106481 <alltraps>
...
80107563:	6a 00                	push   $0x0
  pushl $255
80107565:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
8010756a:	e9 12 ef ff ff       	jmp    80106481 <alltraps>
...
80107572:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80107575:	8b 45 0c             	mov    0xc(%ebp),%eax
80107578:	83 e8 01             	sub    $0x1,%eax
8010757b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010757f:	8b 45 08             	mov    0x8(%ebp),%eax
80107582:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80107586:	8b 45 08             	mov    0x8(%ebp),%eax
80107589:	c1 e8 10             	shr    $0x10,%eax
8010758c:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80107590:	8d 45 fa             	lea    -0x6(%ebp),%eax
80107593:	0f 01 10             	lgdtl  (%eax)
}
80107596:	c9                   	leave  
80107597:	c3                   	ret    
...
801075b1:	83 ec 04             	sub    $0x4,%esp
801075b4:	8b 45 08             	mov    0x8(%ebp),%eax
801075b7:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
801075bb:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
801075bf:	8e e8                	mov    %eax,%gs
}
801075c1:	c9                   	leave  
801075c2:	c3                   	ret    
...
static inline uint v2p(void *a) { return ((uint) (a))  - KERNBASE; }
801075ce:	55                   	push   %ebp
801075cf:	89 e5                	mov    %esp,%ebp
...
801075e1:	05 00 00 00 80       	add    $0x80000000,%eax
801075e6:	5d                   	pop    %ebp
801075e7:	c3                   	ret    
...
801075ec:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];  
801075ef:	e8 84 b8 ff ff       	call   80102e78 <cpunum>
801075f4:	89 c2                	mov    %eax,%edx
801075f6:	89 d0                	mov    %edx,%eax
801075f8:	01 c0                	add    %eax,%eax
801075fa:	01 d0                	add    %edx,%eax
801075fc:	c1 e0 06             	shl    $0x6,%eax
801075ff:	05 60 23 11 80       	add    $0x80112360,%eax
80107604:	89 45 f4             	mov    %eax,-0xc(%ebp)

  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80107607:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010760a:	66 c7 40 7c ff ff    	movw   $0xffff,0x7c(%eax)
80107610:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107613:	66 c7 40 7e 00 00    	movw   $0x0,0x7e(%eax)
80107619:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010761c:	c6 80 80 00 00 00 00 	movb   $0x0,0x80(%eax)
80107623:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107626:	0f b6 90 81 00 00 00 	movzbl 0x81(%eax),%edx
8010762d:	83 e2 f0             	and    $0xfffffff0,%edx
80107630:	83 ca 0a             	or     $0xa,%edx
80107633:	88 90 81 00 00 00    	mov    %dl,0x81(%eax)
80107639:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010763c:	0f b6 90 81 00 00 00 	movzbl 0x81(%eax),%edx
80107643:	83 ca 10             	or     $0x10,%edx
80107646:	88 90 81 00 00 00    	mov    %dl,0x81(%eax)
8010764c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010764f:	0f b6 90 81 00 00 00 	movzbl 0x81(%eax),%edx
80107656:	83 e2 9f             	and    $0xffffff9f,%edx
80107659:	88 90 81 00 00 00    	mov    %dl,0x81(%eax)
8010765f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107662:	0f b6 90 81 00 00 00 	movzbl 0x81(%eax),%edx
80107669:	83 ca 80             	or     $0xffffff80,%edx
8010766c:	88 90 81 00 00 00    	mov    %dl,0x81(%eax)
80107672:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107675:	0f b6 90 82 00 00 00 	movzbl 0x82(%eax),%edx
8010767c:	83 ca 0f             	or     $0xf,%edx
8010767f:	88 90 82 00 00 00    	mov    %dl,0x82(%eax)
80107685:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107688:	0f b6 90 82 00 00 00 	movzbl 0x82(%eax),%edx
8010768f:	83 e2 ef             	and    $0xffffffef,%edx
80107692:	88 90 82 00 00 00    	mov    %dl,0x82(%eax)
80107698:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010769b:	0f b6 90 82 00 00 00 	movzbl 0x82(%eax),%edx
801076a2:	83 e2 df             	and    $0xffffffdf,%edx
801076a5:	88 90 82 00 00 00    	mov    %dl,0x82(%eax)
801076ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076ae:	0f b6 90 82 00 00 00 	movzbl 0x82(%eax),%edx
801076b5:	83 ca 40             	or     $0x40,%edx
801076b8:	88 90 82 00 00 00    	mov    %dl,0x82(%eax)
801076be:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076c1:	0f b6 90 82 00 00 00 	movzbl 0x82(%eax),%edx
801076c8:	83 ca 80             	or     $0xffffff80,%edx
801076cb:	88 90 82 00 00 00    	mov    %dl,0x82(%eax)
801076d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076d4:	c6 80 83 00 00 00 00 	movb   $0x0,0x83(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801076db:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076de:	66 c7 80 84 00 00 00 	movw   $0xffff,0x84(%eax)
801076e5:	ff ff 
801076e7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076ea:	66 c7 80 86 00 00 00 	movw   $0x0,0x86(%eax)
801076f1:	00 00 
801076f3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076f6:	c6 80 88 00 00 00 00 	movb   $0x0,0x88(%eax)
801076fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107700:	0f b6 90 89 00 00 00 	movzbl 0x89(%eax),%edx
80107707:	83 e2 f0             	and    $0xfffffff0,%edx
8010770a:	83 ca 02             	or     $0x2,%edx
8010770d:	88 90 89 00 00 00    	mov    %dl,0x89(%eax)
80107713:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107716:	0f b6 90 89 00 00 00 	movzbl 0x89(%eax),%edx
8010771d:	83 ca 10             	or     $0x10,%edx
80107720:	88 90 89 00 00 00    	mov    %dl,0x89(%eax)
80107726:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107729:	0f b6 90 89 00 00 00 	movzbl 0x89(%eax),%edx
80107730:	83 e2 9f             	and    $0xffffff9f,%edx
80107733:	88 90 89 00 00 00    	mov    %dl,0x89(%eax)
80107739:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010773c:	0f b6 90 89 00 00 00 	movzbl 0x89(%eax),%edx
80107743:	83 ca 80             	or     $0xffffff80,%edx
80107746:	88 90 89 00 00 00    	mov    %dl,0x89(%eax)
8010774c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010774f:	0f b6 90 8a 00 00 00 	movzbl 0x8a(%eax),%edx
80107756:	83 ca 0f             	or     $0xf,%edx
80107759:	88 90 8a 00 00 00    	mov    %dl,0x8a(%eax)
8010775f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107762:	0f b6 90 8a 00 00 00 	movzbl 0x8a(%eax),%edx
80107769:	83 e2 ef             	and    $0xffffffef,%edx
8010776c:	88 90 8a 00 00 00    	mov    %dl,0x8a(%eax)
80107772:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107775:	0f b6 90 8a 00 00 00 	movzbl 0x8a(%eax),%edx
8010777c:	83 e2 df             	and    $0xffffffdf,%edx
8010777f:	88 90 8a 00 00 00    	mov    %dl,0x8a(%eax)
80107785:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107788:	0f b6 90 8a 00 00 00 	movzbl 0x8a(%eax),%edx
8010778f:	83 ca 40             	or     $0x40,%edx
80107792:	88 90 8a 00 00 00    	mov    %dl,0x8a(%eax)
80107798:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010779b:	0f b6 90 8a 00 00 00 	movzbl 0x8a(%eax),%edx
801077a2:	83 ca 80             	or     $0xffffff80,%edx
801077a5:	88 90 8a 00 00 00    	mov    %dl,0x8a(%eax)
801077ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077ae:	c6 80 8b 00 00 00 00 	movb   $0x0,0x8b(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801077b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077b8:	66 c7 80 94 00 00 00 	movw   $0xffff,0x94(%eax)
801077bf:	ff ff 
801077c1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077c4:	66 c7 80 96 00 00 00 	movw   $0x0,0x96(%eax)
801077cb:	00 00 
801077cd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077d0:	c6 80 98 00 00 00 00 	movb   $0x0,0x98(%eax)
801077d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077da:	0f b6 90 99 00 00 00 	movzbl 0x99(%eax),%edx
801077e1:	83 e2 f0             	and    $0xfffffff0,%edx
801077e4:	83 ca 0a             	or     $0xa,%edx
801077e7:	88 90 99 00 00 00    	mov    %dl,0x99(%eax)
801077ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077f0:	0f b6 90 99 00 00 00 	movzbl 0x99(%eax),%edx
801077f7:	83 ca 10             	or     $0x10,%edx
801077fa:	88 90 99 00 00 00    	mov    %dl,0x99(%eax)
80107800:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107803:	0f b6 90 99 00 00 00 	movzbl 0x99(%eax),%edx
8010780a:	83 ca 60             	or     $0x60,%edx
8010780d:	88 90 99 00 00 00    	mov    %dl,0x99(%eax)
80107813:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107816:	0f b6 90 99 00 00 00 	movzbl 0x99(%eax),%edx
8010781d:	83 ca 80             	or     $0xffffff80,%edx
80107820:	88 90 99 00 00 00    	mov    %dl,0x99(%eax)
80107826:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107829:	0f b6 90 9a 00 00 00 	movzbl 0x9a(%eax),%edx
80107830:	83 ca 0f             	or     $0xf,%edx
80107833:	88 90 9a 00 00 00    	mov    %dl,0x9a(%eax)
80107839:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010783c:	0f b6 90 9a 00 00 00 	movzbl 0x9a(%eax),%edx
80107843:	83 e2 ef             	and    $0xffffffef,%edx
80107846:	88 90 9a 00 00 00    	mov    %dl,0x9a(%eax)
8010784c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010784f:	0f b6 90 9a 00 00 00 	movzbl 0x9a(%eax),%edx
80107856:	83 e2 df             	and    $0xffffffdf,%edx
80107859:	88 90 9a 00 00 00    	mov    %dl,0x9a(%eax)
8010785f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107862:	0f b6 90 9a 00 00 00 	movzbl 0x9a(%eax),%edx
80107869:	83 ca 40             	or     $0x40,%edx
8010786c:	88 90 9a 00 00 00    	mov    %dl,0x9a(%eax)
80107872:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107875:	0f b6 90 9a 00 00 00 	movzbl 0x9a(%eax),%edx
8010787c:	83 ca 80             	or     $0xffffff80,%edx
8010787f:	88 90 9a 00 00 00    	mov    %dl,0x9a(%eax)
80107885:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107888:	c6 80 9b 00 00 00 00 	movb   $0x0,0x9b(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010788f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107892:	66 c7 80 9c 00 00 00 	movw   $0xffff,0x9c(%eax)
80107899:	ff ff 
8010789b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010789e:	66 c7 80 9e 00 00 00 	movw   $0x0,0x9e(%eax)
801078a5:	00 00 
801078a7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078aa:	c6 80 a0 00 00 00 00 	movb   $0x0,0xa0(%eax)
801078b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078b4:	0f b6 90 a1 00 00 00 	movzbl 0xa1(%eax),%edx
801078bb:	83 e2 f0             	and    $0xfffffff0,%edx
801078be:	83 ca 02             	or     $0x2,%edx
801078c1:	88 90 a1 00 00 00    	mov    %dl,0xa1(%eax)
801078c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078ca:	0f b6 90 a1 00 00 00 	movzbl 0xa1(%eax),%edx
801078d1:	83 ca 10             	or     $0x10,%edx
801078d4:	88 90 a1 00 00 00    	mov    %dl,0xa1(%eax)
801078da:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078dd:	0f b6 90 a1 00 00 00 	movzbl 0xa1(%eax),%edx
801078e4:	83 ca 60             	or     $0x60,%edx
801078e7:	88 90 a1 00 00 00    	mov    %dl,0xa1(%eax)
801078ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078f0:	0f b6 90 a1 00 00 00 	movzbl 0xa1(%eax),%edx
801078f7:	83 ca 80             	or     $0xffffff80,%edx
801078fa:	88 90 a1 00 00 00    	mov    %dl,0xa1(%eax)
80107900:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107903:	0f b6 90 a2 00 00 00 	movzbl 0xa2(%eax),%edx
8010790a:	83 ca 0f             	or     $0xf,%edx
8010790d:	88 90 a2 00 00 00    	mov    %dl,0xa2(%eax)
80107913:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107916:	0f b6 90 a2 00 00 00 	movzbl 0xa2(%eax),%edx
8010791d:	83 e2 ef             	and    $0xffffffef,%edx
80107920:	88 90 a2 00 00 00    	mov    %dl,0xa2(%eax)
80107926:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107929:	0f b6 90 a2 00 00 00 	movzbl 0xa2(%eax),%edx
80107930:	83 e2 df             	and    $0xffffffdf,%edx
80107933:	88 90 a2 00 00 00    	mov    %dl,0xa2(%eax)
80107939:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010793c:	0f b6 90 a2 00 00 00 	movzbl 0xa2(%eax),%edx
80107943:	83 ca 40             	or     $0x40,%edx
80107946:	88 90 a2 00 00 00    	mov    %dl,0xa2(%eax)
8010794c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010794f:	0f b6 90 a2 00 00 00 	movzbl 0xa2(%eax),%edx
80107956:	83 ca 80             	or     $0xffffff80,%edx
80107959:	88 90 a2 00 00 00    	mov    %dl,0xa2(%eax)
8010795f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107962:	c6 80 a3 00 00 00 00 	movb   $0x0,0xa3(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80107969:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010796c:	05 b8 00 00 00       	add    $0xb8,%eax
80107971:	89 c3                	mov    %eax,%ebx
80107973:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107976:	05 b8 00 00 00       	add    $0xb8,%eax
8010797b:	c1 e8 10             	shr    $0x10,%eax
8010797e:	89 c1                	mov    %eax,%ecx
80107980:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107983:	05 b8 00 00 00       	add    $0xb8,%eax
80107988:	c1 e8 18             	shr    $0x18,%eax
8010798b:	89 c2                	mov    %eax,%edx
8010798d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107990:	66 c7 80 8c 00 00 00 	movw   $0x0,0x8c(%eax)
80107997:	00 00 
80107999:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010799c:	66 89 98 8e 00 00 00 	mov    %bx,0x8e(%eax)
801079a3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079a6:	88 88 90 00 00 00    	mov    %cl,0x90(%eax)
801079ac:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079af:	0f b6 88 91 00 00 00 	movzbl 0x91(%eax),%ecx
801079b6:	83 e1 f0             	and    $0xfffffff0,%ecx
801079b9:	83 c9 02             	or     $0x2,%ecx
801079bc:	88 88 91 00 00 00    	mov    %cl,0x91(%eax)
801079c2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079c5:	0f b6 88 91 00 00 00 	movzbl 0x91(%eax),%ecx
801079cc:	83 c9 10             	or     $0x10,%ecx
801079cf:	88 88 91 00 00 00    	mov    %cl,0x91(%eax)
801079d5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079d8:	0f b6 88 91 00 00 00 	movzbl 0x91(%eax),%ecx
801079df:	83 e1 9f             	and    $0xffffff9f,%ecx
801079e2:	88 88 91 00 00 00    	mov    %cl,0x91(%eax)
801079e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079eb:	0f b6 88 91 00 00 00 	movzbl 0x91(%eax),%ecx
801079f2:	83 c9 80             	or     $0xffffff80,%ecx
801079f5:	88 88 91 00 00 00    	mov    %cl,0x91(%eax)
801079fb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079fe:	0f b6 88 92 00 00 00 	movzbl 0x92(%eax),%ecx
80107a05:	83 e1 f0             	and    $0xfffffff0,%ecx
80107a08:	88 88 92 00 00 00    	mov    %cl,0x92(%eax)
80107a0e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a11:	0f b6 88 92 00 00 00 	movzbl 0x92(%eax),%ecx
80107a18:	83 e1 ef             	and    $0xffffffef,%ecx
80107a1b:	88 88 92 00 00 00    	mov    %cl,0x92(%eax)
80107a21:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a24:	0f b6 88 92 00 00 00 	movzbl 0x92(%eax),%ecx
80107a2b:	83 e1 df             	and    $0xffffffdf,%ecx
80107a2e:	88 88 92 00 00 00    	mov    %cl,0x92(%eax)
80107a34:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a37:	0f b6 88 92 00 00 00 	movzbl 0x92(%eax),%ecx
80107a3e:	83 c9 40             	or     $0x40,%ecx
80107a41:	88 88 92 00 00 00    	mov    %cl,0x92(%eax)
80107a47:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a4a:	0f b6 88 92 00 00 00 	movzbl 0x92(%eax),%ecx
80107a51:	83 c9 80             	or     $0xffffff80,%ecx
80107a54:	88 88 92 00 00 00    	mov    %cl,0x92(%eax)
80107a5a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a5d:	88 90 93 00 00 00    	mov    %dl,0x93(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80107a63:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a66:	83 c0 74             	add    $0x74,%eax
80107a69:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80107a70:	00 
80107a71:	89 04 24             	mov    %eax,(%esp)
80107a74:	e8 f6 fa ff ff       	call   8010756f <lgdt>
  loadgs(SEG_KCPU << 3);
80107a79:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
80107a80:	e8 29 fb ff ff       	call   801075ae <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
80107a85:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a88:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
80107a8e:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80107a95:	00 00 00 00 
}
80107a99:	83 c4 24             	add    $0x24,%esp
80107a9c:	5b                   	pop    %ebx
80107a9d:	5d                   	pop    %ebp
80107a9e:	c3                   	ret    
...
80107aa2:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80107aa5:	8b 45 0c             	mov    0xc(%ebp),%eax
80107aa8:	c1 e8 16             	shr    $0x16,%eax
80107aab:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80107ab2:	8b 45 08             	mov    0x8(%ebp),%eax
80107ab5:	01 d0                	add    %edx,%eax
80107ab7:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
80107aba:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107abd:	8b 00                	mov    (%eax),%eax
80107abf:	83 e0 01             	and    $0x1,%eax
80107ac2:	85 c0                	test   %eax,%eax
80107ac4:	74 17                	je     80107add <walkpgdir+0x3e>
    pgtab = (pte_t*)p2v(PTE_ADDR(*pde));
80107ac6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107ac9:	8b 00                	mov    (%eax),%eax
80107acb:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107ad0:	89 04 24             	mov    %eax,(%esp)
80107ad3:	e8 03 fb ff ff       	call   801075db <p2v>
80107ad8:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107adb:	eb 4b                	jmp    80107b28 <walkpgdir+0x89>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80107add:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80107ae1:	74 0e                	je     80107af1 <walkpgdir+0x52>
80107ae3:	e8 fa af ff ff       	call   80102ae2 <kalloc>
80107ae8:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107aeb:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107aef:	75 07                	jne    80107af8 <walkpgdir+0x59>
      return 0;
80107af1:	b8 00 00 00 00       	mov    $0x0,%eax
80107af6:	eb 47                	jmp    80107b3f <walkpgdir+0xa0>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80107af8:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107aff:	00 
80107b00:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107b07:	00 
80107b08:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b0b:	89 04 24             	mov    %eax,(%esp)
80107b0e:	e8 64 d5 ff ff       	call   80105077 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table 
    // entries, if necessary.
    *pde = v2p(pgtab) | PTE_P | PTE_W | PTE_U;
80107b13:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b16:	89 04 24             	mov    %eax,(%esp)
80107b19:	e8 b0 fa ff ff       	call   801075ce <v2p>
80107b1e:	83 c8 07             	or     $0x7,%eax
80107b21:	89 c2                	mov    %eax,%edx
80107b23:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107b26:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80107b28:	8b 45 0c             	mov    0xc(%ebp),%eax
80107b2b:	c1 e8 0c             	shr    $0xc,%eax
80107b2e:	25 ff 03 00 00       	and    $0x3ff,%eax
80107b33:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
80107b44:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;
  
  a = (char*)PGROUNDDOWN((uint)va);
80107b47:	8b 45 0c             	mov    0xc(%ebp),%eax
80107b4a:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107b4f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80107b52:	8b 55 0c             	mov    0xc(%ebp),%edx
80107b55:	8b 45 10             	mov    0x10(%ebp),%eax
80107b58:	01 d0                	add    %edx,%eax
80107b5a:	83 e8 01             	sub    $0x1,%eax
...
80107bbd:	75 08                	jne    80107bc7 <mappages+0x86>
      break;
80107bbf:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
...
80107bc5:	eb 10                	jmp    80107bd7 <mappages+0x96>
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
    if(a == last)
      break;
    a += PGSIZE;
80107bc7:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
80107bce:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
80107bd5:	eb 8e                	jmp    80107b65 <mappages+0x24>
  return 0;
}
80107bd7:	c9                   	leave  
80107bd8:	c3                   	ret    
...
80107bdc:	53                   	push   %ebx
80107bdd:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107be0:	e8 fd ae ff ff       	call   80102ae2 <kalloc>
80107be5:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107be8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107bec:	75 0a                	jne    80107bf8 <setupkvm+0x1f>
    return 0;
80107bee:	b8 00 00 00 00       	mov    $0x0,%eax
80107bf3:	e9 98 00 00 00       	jmp    80107c90 <setupkvm+0xb7>
...
80107c0e:	e8 64 d4 ff ff       	call   80105077 <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80107c13:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80107c1a:	e8 bc f9 ff ff       	call   801075db <p2v>
80107c1f:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80107c24:	76 0c                	jbe    80107c32 <setupkvm+0x59>
    panic("PHYSTOP too high");
80107c26:	c7 04 24 2a 8a 10 80 	movl   $0x80108a2a,(%esp)
80107c2d:	e8 08 89 ff ff       	call   8010053a <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107c32:	c7 45 f4 a0 b4 10 80 	movl   $0x8010b4a0,-0xc(%ebp)
80107c39:	eb 49                	jmp    80107c84 <setupkvm+0xab>
...
80107c70:	e8 cc fe ff ff       	call   80107b41 <mappages>
80107c75:	85 c0                	test   %eax,%eax
80107c77:	79 07                	jns    80107c80 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80107c79:	b8 00 00 00 00       	mov    $0x0,%eax
80107c7e:	eb 10                	jmp    80107c90 <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107c80:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107c84:	81 7d f4 e0 b4 10 80 	cmpl   $0x8010b4e0,-0xc(%ebp)
80107c8b:	72 ae                	jb     80107c3b <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
80107c90:	83 c4 34             	add    $0x34,%esp
80107c93:	5b                   	pop    %ebx
80107c94:	5d                   	pop    %ebp
80107c95:	c3                   	ret    
...
80107c99:	83 ec 18             	sub    $0x18,%esp
  c->kpgdir = setupkvm();
80107c9c:	e8 38 ff ff ff       	call   80107bd9 <setupkvm>
80107ca1:	8b 55 08             	mov    0x8(%ebp),%edx
80107ca4:	89 42 04             	mov    %eax,0x4(%edx)
  switchkvm(c);
80107ca7:	8b 45 08             	mov    0x8(%ebp),%eax
80107caa:	89 04 24             	mov    %eax,(%esp)
80107cad:	e8 02 00 00 00       	call   80107cb4 <switchkvm>
}
80107cb2:	c9                   	leave  
80107cb3:	c3                   	ret    
...
80107cbd:	8b 40 04             	mov    0x4(%eax),%eax
80107cc0:	89 04 24             	mov    %eax,(%esp)
80107cc3:	e8 06 f9 ff ff       	call   801075ce <v2p>
80107cc8:	89 04 24             	mov    %eax,(%esp)
80107ccb:	e8 f3 f8 ff ff       	call   801075c3 <lcr3>
}
80107cd0:	c9                   	leave  
80107cd1:	c3                   	ret    
...
80107cd6:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80107cd9:	e8 99 d2 ff ff       	call   80104f77 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80107cde:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107ce4:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107ceb:	83 c2 0c             	add    $0xc,%edx
80107cee:	89 d3                	mov    %edx,%ebx
80107cf0:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107cf7:	83 c2 0c             	add    $0xc,%edx
80107cfa:	c1 ea 10             	shr    $0x10,%edx
80107cfd:	89 d1                	mov    %edx,%ecx
80107cff:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107d06:	83 c2 0c             	add    $0xc,%edx
80107d09:	c1 ea 18             	shr    $0x18,%edx
80107d0c:	66 c7 80 a4 00 00 00 	movw   $0x67,0xa4(%eax)
80107d13:	67 00 
80107d15:	66 89 98 a6 00 00 00 	mov    %bx,0xa6(%eax)
80107d1c:	88 88 a8 00 00 00    	mov    %cl,0xa8(%eax)
80107d22:	0f b6 88 a9 00 00 00 	movzbl 0xa9(%eax),%ecx
80107d29:	83 e1 f0             	and    $0xfffffff0,%ecx
80107d2c:	83 c9 09             	or     $0x9,%ecx
80107d2f:	88 88 a9 00 00 00    	mov    %cl,0xa9(%eax)
80107d35:	0f b6 88 a9 00 00 00 	movzbl 0xa9(%eax),%ecx
80107d3c:	83 c9 10             	or     $0x10,%ecx
80107d3f:	88 88 a9 00 00 00    	mov    %cl,0xa9(%eax)
80107d45:	0f b6 88 a9 00 00 00 	movzbl 0xa9(%eax),%ecx
80107d4c:	83 e1 9f             	and    $0xffffff9f,%ecx
80107d4f:	88 88 a9 00 00 00    	mov    %cl,0xa9(%eax)
80107d55:	0f b6 88 a9 00 00 00 	movzbl 0xa9(%eax),%ecx
80107d5c:	83 c9 80             	or     $0xffffff80,%ecx
80107d5f:	88 88 a9 00 00 00    	mov    %cl,0xa9(%eax)
80107d65:	0f b6 88 aa 00 00 00 	movzbl 0xaa(%eax),%ecx
80107d6c:	83 e1 f0             	and    $0xfffffff0,%ecx
80107d6f:	88 88 aa 00 00 00    	mov    %cl,0xaa(%eax)
80107d75:	0f b6 88 aa 00 00 00 	movzbl 0xaa(%eax),%ecx
80107d7c:	83 e1 ef             	and    $0xffffffef,%ecx
80107d7f:	88 88 aa 00 00 00    	mov    %cl,0xaa(%eax)
80107d85:	0f b6 88 aa 00 00 00 	movzbl 0xaa(%eax),%ecx
80107d8c:	83 e1 df             	and    $0xffffffdf,%ecx
80107d8f:	88 88 aa 00 00 00    	mov    %cl,0xaa(%eax)
80107d95:	0f b6 88 aa 00 00 00 	movzbl 0xaa(%eax),%ecx
80107d9c:	83 c9 40             	or     $0x40,%ecx
80107d9f:	88 88 aa 00 00 00    	mov    %cl,0xaa(%eax)
80107da5:	0f b6 88 aa 00 00 00 	movzbl 0xaa(%eax),%ecx
80107dac:	83 e1 7f             	and    $0x7f,%ecx
80107daf:	88 88 aa 00 00 00    	mov    %cl,0xaa(%eax)
80107db5:	88 90 ab 00 00 00    	mov    %dl,0xab(%eax)
  cpu->gdt[SEG_TSS].s = 0;
80107dbb:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107dc1:	0f b6 90 a9 00 00 00 	movzbl 0xa9(%eax),%edx
80107dc8:	83 e2 ef             	and    $0xffffffef,%edx
80107dcb:	88 90 a9 00 00 00    	mov    %dl,0xa9(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
80107dd1:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107dd7:	66 c7 40 14 10 00    	movw   $0x10,0x14(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80107ddd:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107de3:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80107dea:	8b 52 08             	mov    0x8(%edx),%edx
80107ded:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107df3:	89 50 10             	mov    %edx,0x10(%eax)
  ltr(SEG_TSS << 3);
80107df6:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
80107dfd:	e8 96 f7 ff ff       	call   80107598 <ltr>
  if(p->pgdir == 0)
80107e02:	8b 45 08             	mov    0x8(%ebp),%eax
80107e05:	8b 40 04             	mov    0x4(%eax),%eax
80107e08:	85 c0                	test   %eax,%eax
80107e0a:	75 0c                	jne    80107e18 <switchuvm+0x146>
    panic("switchuvm: no pgdir");
80107e0c:	c7 04 24 3b 8a 10 80 	movl   $0x80108a3b,(%esp)
80107e13:	e8 22 87 ff ff       	call   8010053a <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80107e18:	8b 45 08             	mov    0x8(%ebp),%eax
80107e1b:	8b 40 04             	mov    0x4(%eax),%eax
80107e1e:	89 04 24             	mov    %eax,(%esp)
80107e21:	e8 a8 f7 ff ff       	call   801075ce <v2p>
80107e26:	89 04 24             	mov    %eax,(%esp)
80107e29:	e8 95 f7 ff ff       	call   801075c3 <lcr3>
  popcli();
80107e2e:	e8 88 d1 ff ff       	call   80104fbb <popcli>
}
80107e33:	83 c4 14             	add    $0x14,%esp
80107e36:	5b                   	pop    %ebx
80107e37:	5d                   	pop    %ebp
80107e38:	c3                   	ret    
...
80107e3c:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
80107e3f:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80107e46:	76 0c                	jbe    80107e54 <inituvm+0x1b>
    panic("inituvm: more than a page");
80107e48:	c7 04 24 4f 8a 10 80 	movl   $0x80108a4f,(%esp)
80107e4f:	e8 e6 86 ff ff       	call   8010053a <panic>
  mem = kalloc();
80107e54:	e8 89 ac ff ff       	call   80102ae2 <kalloc>
...
80107e72:	e8 00 d2 ff ff       	call   80105077 <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80107e77:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e7a:	89 04 24             	mov    %eax,(%esp)
80107e7d:	e8 4c f7 ff ff       	call   801075ce <v2p>
80107e82:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107e89:	00 
80107e8a:	89 44 24 0c          	mov    %eax,0xc(%esp)
80107e8e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107e95:	00 
80107e96:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107e9d:	00 
80107e9e:	8b 45 08             	mov    0x8(%ebp),%eax
80107ea1:	89 04 24             	mov    %eax,(%esp)
80107ea4:	e8 98 fc ff ff       	call   80107b41 <mappages>
  memmove(mem, init, sz);
80107ea9:	8b 45 10             	mov    0x10(%ebp),%eax
80107eac:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80107ebd:	e8 84 d2 ff ff       	call   80105146 <memmove>
}
80107ec2:	c9                   	leave  
80107ec3:	c3                   	ret    
...
80107ec7:	53                   	push   %ebx
80107ec8:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
80107ecb:	8b 45 0c             	mov    0xc(%ebp),%eax
80107ece:	25 ff 0f 00 00       	and    $0xfff,%eax
80107ed3:	85 c0                	test   %eax,%eax
80107ed5:	74 0c                	je     80107ee3 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
80107ed7:	c7 04 24 6c 8a 10 80 	movl   $0x80108a6c,(%esp)
80107ede:	e8 57 86 ff ff       	call   8010053a <panic>
  for(i = 0; i < sz; i += PGSIZE){
80107ee3:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107eea:	e9 a9 00 00 00       	jmp    80107f98 <loaduvm+0xd4>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80107eef:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ef2:	8b 55 0c             	mov    0xc(%ebp),%edx
80107ef5:	01 d0                	add    %edx,%eax
80107ef7:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107efe:	00 
80107eff:	89 44 24 04          	mov    %eax,0x4(%esp)
80107f03:	8b 45 08             	mov    0x8(%ebp),%eax
80107f06:	89 04 24             	mov    %eax,(%esp)
80107f09:	e8 91 fb ff ff       	call   80107a9f <walkpgdir>
80107f0e:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107f11:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107f15:	75 0c                	jne    80107f23 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
80107f17:	c7 04 24 8f 8a 10 80 	movl   $0x80108a8f,(%esp)
80107f1e:	e8 17 86 ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
80107f23:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107f26:	8b 00                	mov    (%eax),%eax
80107f28:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107f2d:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
80107f30:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f33:	8b 55 18             	mov    0x18(%ebp),%edx
80107f36:	29 c2                	sub    %eax,%edx
80107f38:	89 d0                	mov    %edx,%eax
80107f3a:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80107f3f:	77 0f                	ja     80107f50 <loaduvm+0x8c>
      n = sz - i;
80107f41:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f44:	8b 55 18             	mov    0x18(%ebp),%edx
80107f47:	29 c2                	sub    %eax,%edx
80107f49:	89 d0                	mov    %edx,%eax
80107f4b:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107f4e:	eb 07                	jmp    80107f57 <loaduvm+0x93>
    else
      n = PGSIZE;
80107f50:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
80107f57:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f5a:	8b 55 14             	mov    0x14(%ebp),%edx
80107f5d:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80107f60:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107f63:	89 04 24             	mov    %eax,(%esp)
80107f66:	e8 70 f6 ff ff       	call   801075db <p2v>
80107f6b:	8b 55 f0             	mov    -0x10(%ebp),%edx
...
80107f80:	e8 e3 9d ff ff       	call   80101d68 <readi>
80107f85:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107f88:	74 07                	je     80107f91 <loaduvm+0xcd>
      return -1;
80107f8a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107f8f:	eb 18                	jmp    80107fa9 <loaduvm+0xe5>
  uint i, pa, n;
  pte_t *pte;
...
80107f9b:	3b 45 18             	cmp    0x18(%ebp),%eax
80107f9e:	0f 82 4b ff ff ff    	jb     80107eef <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
  ...
  return 0;
80107fa4:	b8 00 00 00 00       	mov    $0x0,%eax
}
...
80107fb2:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
80107fba:	79 0a                	jns    80107fc6 <allocuvm+0x17>
    return 0;
80107fbc:	b8 00 00 00 00       	mov    $0x0,%eax
80107fc1:	e9 c1 00 00 00       	jmp    80108087 <allocuvm+0xd8>
  if(newsz < oldsz)
80107fc6:	8b 45 10             	mov    0x10(%ebp),%eax
80107fc9:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107fcc:	73 08                	jae    80107fd6 <allocuvm+0x27>
    return oldsz;
80107fce:	8b 45 0c             	mov    0xc(%ebp),%eax
80107fd1:	e9 b1 00 00 00       	jmp    80108087 <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
80107fd6:	8b 45 0c             	mov    0xc(%ebp),%eax
80107fd9:	05 ff 0f 00 00       	add    $0xfff,%eax
80107fde:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107fe3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
80107fe6:	e9 8d 00 00 00       	jmp    80108078 <allocuvm+0xc9>
    mem = kalloc();
80107feb:	e8 f2 aa ff ff       	call   80102ae2 <kalloc>
80107ff0:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80107ff3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107ff7:	75 2c                	jne    80108025 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
80107ff9:	c7 04 24 ad 8a 10 80 	movl   $0x80108aad,(%esp)
80108000:	e8 9b 83 ff ff       	call   801003a0 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80108005:	8b 45 0c             	mov    0xc(%ebp),%eax
80108008:	89 44 24 08          	mov    %eax,0x8(%esp)
8010800c:	8b 45 10             	mov    0x10(%ebp),%eax
8010800f:	89 44 24 04          	mov    %eax,0x4(%esp)
80108013:	8b 45 08             	mov    0x8(%ebp),%eax
80108016:	89 04 24             	mov    %eax,(%esp)
80108019:	e8 6b 00 00 00       	call   80108089 <deallocuvm>
      return 0;
8010801e:	b8 00 00 00 00       	mov    $0x0,%eax
80108023:	eb 62                	jmp    80108087 <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
...
8010803b:	e8 37 d0 ff ff       	call   80105077 <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108040:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108043:	89 04 24             	mov    %eax,(%esp)
80108046:	e8 83 f5 ff ff       	call   801075ce <v2p>
8010804b:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010804e:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108055:	00 
80108056:	89 44 24 0c          	mov    %eax,0xc(%esp)
...
8010806c:	e8 d0 fa ff ff       	call   80107b41 <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
80108071:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108078:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010807b:	3b 45 10             	cmp    0x10(%ebp),%eax
8010807e:	0f 82 67 ff ff ff    	jb     80107feb <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
8010808c:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
8010808f:	8b 45 10             	mov    0x10(%ebp),%eax
80108092:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108095:	72 08                	jb     8010809f <deallocuvm+0x16>
    return oldsz;
80108097:	8b 45 0c             	mov    0xc(%ebp),%eax
8010809a:	e9 a4 00 00 00       	jmp    80108143 <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
8010809f:	8b 45 10             	mov    0x10(%ebp),%eax
801080a2:	05 ff 0f 00 00       	add    $0xfff,%eax
801080a7:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801080ac:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
801080af:	e9 80 00 00 00       	jmp    80108134 <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
801080b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080b7:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801080be:	00 
801080bf:	89 44 24 04          	mov    %eax,0x4(%esp)
801080c3:	8b 45 08             	mov    0x8(%ebp),%eax
801080c6:	89 04 24             	mov    %eax,(%esp)
801080c9:	e8 d1 f9 ff ff       	call   80107a9f <walkpgdir>
801080ce:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
801080d1:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801080d5:	75 09                	jne    801080e0 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
801080d7:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
801080de:	eb 4d                	jmp    8010812d <deallocuvm+0xa4>

    else if((*pte & PTE_P) != 0){
801080e0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801080e3:	8b 00                	mov    (%eax),%eax
801080e5:	83 e0 01             	and    $0x1,%eax
801080e8:	85 c0                	test   %eax,%eax
801080ea:	74 41                	je     8010812d <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
801080ec:	8b 45 f0             	mov    -0x10(%ebp),%eax
801080ef:	8b 00                	mov    (%eax),%eax
801080f1:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801080f6:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
801080f9:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801080fd:	75 0c                	jne    8010810b <deallocuvm+0x82>
        panic("kfree");
801080ff:	c7 04 24 c5 8a 10 80 	movl   $0x80108ac5,(%esp)
80108106:	e8 2f 84 ff ff       	call   8010053a <panic>
      char *v = p2v(pa);
8010810b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010810e:	89 04 24             	mov    %eax,(%esp)
80108111:	e8 c5 f4 ff ff       	call   801075db <p2v>
80108116:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80108119:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010811c:	89 04 24             	mov    %eax,(%esp)
8010811f:	e8 25 a9 ff ff       	call   80102a49 <kfree>
      *pte = 0;
80108124:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108127:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
...
8010813a:	0f 82 74 ff ff ff    	jb     801080b4 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
80108148:	83 ec 28             	sub    $0x28,%esp
  ...
  if(pgdir == 0)
8010814b:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
8010814f:	75 0c                	jne    8010815d <freevm+0x18>
    panic("freevm: no pgdir");
80108151:	c7 04 24 cb 8a 10 80 	movl   $0x80108acb,(%esp)
80108158:	e8 dd 83 ff ff       	call   8010053a <panic>
  deallocuvm(pgdir, KERNBASE, 0);
8010815d:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108164:	00 
80108165:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
8010816c:	80 
8010816d:	8b 45 08             	mov    0x8(%ebp),%eax
80108170:	89 04 24             	mov    %eax,(%esp)
80108173:	e8 11 ff ff ff       	call   80108089 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80108178:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010817f:	eb 48                	jmp    801081c9 <freevm+0x84>
    if(pgdir[i] & PTE_P){
...
80108197:	74 2c                	je     801081c5 <freevm+0x80>
      char * v = p2v(PTE_ADDR(pgdir[i]));
80108199:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010819c:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
801081c0:	e8 84 a8 ff ff       	call   80102a49 <kfree>
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
801081c5:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801081c9:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
801081d0:	76 af                	jbe    80108181 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
801081d8:	e8 6c a8 ff ff       	call   80102a49 <kfree>
}
801081dd:	c9                   	leave  
801081de:	c3                   	ret    
...
801081e5:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801081ec:	00 
...
801081fa:	e8 a0 f8 ff ff       	call   80107a9f <walkpgdir>
801081ff:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80108202:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108206:	75 0c                	jne    80108214 <clearpteu+0x35>
    panic("clearpteu");
80108208:	c7 04 24 dc 8a 10 80 	movl   $0x80108adc,(%esp)
8010820f:	e8 26 83 ff ff       	call   8010053a <panic>
  *pte &= ~PTE_U;
80108214:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108217:	8b 00                	mov    (%eax),%eax
80108219:	83 e0 fb             	and    $0xfffffffb,%eax
8010821c:	89 c2                	mov    %eax,%edx
8010821e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108221:	89 10                	mov    %edx,(%eax)
}
80108223:	c9                   	leave  
80108224:	c3                   	ret    
...
80108229:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
8010822c:	e8 a8 f9 ff ff       	call   80107bd9 <setupkvm>
80108231:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108234:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108238:	75 0a                	jne    80108244 <copyuvm+0x1f>
    return 0;
8010823a:	b8 00 00 00 00       	mov    $0x0,%eax
8010823f:	e9 fd 00 00 00       	jmp    80108341 <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
80108244:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010824b:	e9 d0 00 00 00       	jmp    80108320 <copyuvm+0xfb>
...
80108265:	e8 35 f8 ff ff       	call   80107a9f <walkpgdir>
8010826a:	89 45 ec             	mov    %eax,-0x14(%ebp)
8010826d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108271:	75 0c                	jne    8010827f <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
80108273:	c7 04 24 e6 8a 10 80 	movl   $0x80108ae6,(%esp)
...
80108289:	75 0c                	jne    80108297 <copyuvm+0x72>
      panic("copyuvm: page not present");
8010828b:	c7 04 24 00 8b 10 80 	movl   $0x80108b00,(%esp)
80108292:	e8 a3 82 ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
...
801082a9:	25 ff 0f 00 00       	and    $0xfff,%eax
801082ae:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
801082b1:	e8 2c a8 ff ff       	call   80102ae2 <kalloc>
801082b6:	89 45 e0             	mov    %eax,-0x20(%ebp)
801082b9:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801082bd:	75 02                	jne    801082c1 <copyuvm+0x9c>
      goto bad;
801082bf:	eb 70                	jmp    80108331 <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
801082c1:	8b 45 e8             	mov    -0x18(%ebp),%eax
801082c4:	89 04 24             	mov    %eax,(%esp)
801082c7:	e8 0f f3 ff ff       	call   801075db <p2v>
801082cc:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801082d3:	00 
801082d4:	89 44 24 04          	mov    %eax,0x4(%esp)
801082d8:	8b 45 e0             	mov    -0x20(%ebp),%eax
801082db:	89 04 24             	mov    %eax,(%esp)
801082de:	e8 63 ce ff ff       	call   80105146 <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
801082e3:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
801082e6:	8b 45 e0             	mov    -0x20(%ebp),%eax
801082e9:	89 04 24             	mov    %eax,(%esp)
801082ec:	e8 dd f2 ff ff       	call   801075ce <v2p>
801082f1:	8b 55 f4             	mov    -0xc(%ebp),%edx
801082f4:	89 5c 24 10          	mov    %ebx,0x10(%esp)
801082f8:	89 44 24 0c          	mov    %eax,0xc(%esp)
801082fc:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108303:	00 
80108304:	89 54 24 04          	mov    %edx,0x4(%esp)
80108308:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010830b:	89 04 24             	mov    %eax,(%esp)
8010830e:	e8 2e f8 ff ff       	call   80107b41 <mappages>
80108313:	85 c0                	test   %eax,%eax
80108315:	79 02                	jns    80108319 <copyuvm+0xf4>
      goto bad;
80108317:	eb 18                	jmp    80108331 <copyuvm+0x10c>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80108319:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108320:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108323:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108326:	0f 82 24 ff ff ff    	jb     80108250 <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
8010832f:	eb 10                	jmp    80108341 <copyuvm+0x11c>

bad:
  freevm(d);
80108331:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108334:	89 04 24             	mov    %eax,(%esp)
80108337:	e8 09 fe ff ff       	call   80108145 <freevm>
  return 0;
8010833c:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108341:	83 c4 44             	add    $0x44,%esp
80108344:	5b                   	pop    %ebx
80108345:	5d                   	pop    %ebp
80108346:	c3                   	ret    
...
8010834a:	83 ec 28             	sub    $0x28,%esp
  ...
  pte = walkpgdir(pgdir, uva, 0);
8010834d:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108354:	00 
...
8010839d:	e8 39 f2 ff ff       	call   801075db <p2v>
}
801083a2:	c9                   	leave  
801083a3:	c3                   	ret    
...
801083ad:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
801083b0:	e9 87 00 00 00       	jmp    8010843c <copyout+0x98>
...
801083cd:	e8 75 ff ff ff       	call   80108347 <uva2ka>
801083d2:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
801083d5:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
801083d9:	75 07                	jne    801083e2 <copyout+0x3e>
      return -1;
801083db:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801083e0:	eb 69                	jmp    8010844b <copyout+0xa7>
    n = PGSIZE - (va - va0);
801083e2:	8b 45 0c             	mov    0xc(%ebp),%eax
801083e5:	8b 55 ec             	mov    -0x14(%ebp),%edx
801083e8:	29 c2                	sub    %eax,%edx
801083ea:	89 d0                	mov    %edx,%eax
801083ec:	05 00 10 00 00       	add    $0x1000,%eax
801083f1:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
801083f4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801083f7:	3b 45 14             	cmp    0x14(%ebp),%eax
801083fa:	76 06                	jbe    80108402 <copyout+0x5e>
      n = len;
801083fc:	8b 45 14             	mov    0x14(%ebp),%eax
...
8010840a:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010840d:	01 c2                	add    %eax,%edx
8010840f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108412:	89 44 24 08          	mov    %eax,0x8(%esp)
80108416:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108419:	89 44 24 04          	mov    %eax,0x4(%esp)
8010841d:	89 14 24             	mov    %edx,(%esp)
80108420:	e8 21 cd ff ff       	call   80105146 <memmove>
    len -= n;
80108425:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108428:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
8010842b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010842e:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80108431:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108434:	05 00 10 00 00       	add    $0x1000,%eax
80108439:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
8010843c:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108440:	0f 85 6f ff ff ff    	jne    801083b5 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
